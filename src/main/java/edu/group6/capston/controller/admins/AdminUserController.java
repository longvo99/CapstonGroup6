...
public class AdminUserController {
	...
	public String add(@Valid @ModelAttribute Users users, BindingResult br, RedirectAttributes rd, HttpServletRequest request, Model model) {
		if (br.hasErrors()) {
	...
	public String Edit(@Valid @ModelAttribute Users user, BindingResult br, HttpServletRequest request,
