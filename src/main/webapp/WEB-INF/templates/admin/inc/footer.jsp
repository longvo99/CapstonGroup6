...
<!-- Footer -->
  ...
  <script src="${pageContext.request.contextPath}/resources/admin/assets/vendor/datatables/dataTables.bootstrap4.min.js"></script>
   <!-- ClockPicker -->
  <script src="${pageContext.request.contextPath}/resources/admin/assets/vendor/clock-picker/clockpicker.js"></script>
   <!-- Bootstrap Datepicker -->
  <script src="${pageContext.request.contextPath}/resources/admin/assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
  <!-- Select2 -->
  <script src="${pageContext.request.contextPath}/resources/admin/assets/vendor/select2/dist/js/select2.min.js"></script> 
