...
<!-- footer -->
    ...
    <!-- Range Slider -->
    <script src="${pageContext.request.contextPath}/resources/public/assets/js/ion.rangeSlider.min.js"></script>
    <!-- Swiper Slider -->
    <script src="${pageContext.request.contextPath}/resources/public/assets/js/swiper.min.js"></script>
    <!-- Nice Select -->
    <script src="${pageContext.request.contextPath}/resources/public/assets/js/jquery.nice-select.min.js"></script>
    <!-- magnific popup -->
