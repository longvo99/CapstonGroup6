...
<c:choose>
	<c:when test="${not empty sessionScope.userSession}">
		<c:set var="addUrl" value="${pageContext.request.contextPath}/public/combo/add" />
		<c:set var="editUrl" value="${pageContext.request.contextPath}/public/combo/edit" />
		<c:set var="deleteUrl" value="${pageContext.request.contextPath}/public/combo/del" />
	</c:when>
	<c:otherwise>
		<c:set var="addUrl" value="${pageContext.request.contextPath}/admin/combo/add" />
		<c:set var="editUrl" value="${pageContext.request.contextPath}/admin/combo/edit" />
		<c:set var="deleteUrl" value="${pageContext.request.contextPath}/admin/combo/del" />
	</c:otherwise>
</c:choose>
