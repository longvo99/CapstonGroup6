		...
		<div class="row page-title-header">
			...
			<div class="col-md-12">
				<div class="page-header-toolbar">
					<div class="btn-group toolbar-item" role="group"
					...
					<div class="filter-wrapper">
						<div class="dropdown toolbar-item">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownsorting">
								<a class="dropdown-item" href="#">Last Day</a> <a
					...
					<div class="sort-wrapper">
						...
						<div class="dropdown ml-lg-auto ml-3 toolbar-item">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownexport">
								<a class="dropdown-item" href="#">Export as PDF</a> <a
									class="dropdown-item" href="#">Export as DOCX</a> <a
									class="dropdown-item" href="#">Export as CDR</a>
							</div>
						</div>
					</div>
				</div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex mt-3 py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="${pageContext.request.contextPath}/resources/admin/assets/images/faces/face3.jpg" alt="profile image">
                        ...
                        <div class="d-flex py-2 border-bottom">
                          <img class="img-sm rounded-circle" src="${pageContext.request.contextPath}/resources/admin/assets/images/faces/face4.jpg" alt="profile image">
                          <div class="wrapper ml-2">
