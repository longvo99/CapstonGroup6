						...
						<div class="card-body">
							<form role="form" method="post" name="form" id="form"
								...
								<div class="form-group">
									<label for="locationName">Tên địa điểm</label> <input
										class="form-control mb-3" type="text" value=""
										id="locationName" name="locationName">
								</div>
								<div class="form-group">
									<label for="address">Địa chỉ</label> <input
										class="form-control mb-3" type="text" value="" id="address"
										name="address">
								</div>
								<div class="form-group">
									<label for="openTime">Giờ mở cửa</label> <input
										class="form-control mb-3" type="time" value="" id="openTime"
										name="openTime">
								</div>
								<div class="form-group">
									<label for="closeTime">Giờ đóng cửa</label> <input
										class="form-control mb-3" type="time" value="" id="closeTime"
										name="closeTime">
								</div>
								<div class="form-group">
									<label for="description">Mô tả</label>
									<textarea class="form-control mb-10" id="description" rows="5"
										name="description" placeholder="Nội dung"
								...
								<div class="form-group">
									<label for="locationcategory">Danh mục địa điểm</label> <select
										...
										name="locationCategory.categoryId">
								...
								<div class="form-group">
									<label for="locationtype">Kiểu địa điểm</label> <select
										...
										name="locationType.locationTypeId">
								...
								<div>
									<div class="form-group">
										<label for="">Nước</label> <select class="form-control"
											name="country">
											<option value="Việt Nam">Việt Nam</option>
										</select>
									</div>
									<div class="form-group">
										<label for="country">Tỉnh/thành</label> <select name="city"
											id="country" class="form-control input-lg">
											<option value="000">-Chọn Tỉnh/Thành:-</option>
										</select>
									</div>
									<div class="form-group">
										<label for="state">Quận huyện</label> <select name="district"
											id="state" class="form-control input-lg">
											<option value="000">-Chọn Quận/Huyện-</option>
										</select>
									</div>
									<div class="form-group">
										<label for="city">Xã/phường</label> <select name="ward"
											id="city" class="form-control input-lg">
								...
								<div class="form-group">
									<label for="locationEmail">Email</label> <input
										class="form-control mb-3" type="text"
                ...
                <div class="card-body">
                  <form role="form" method="post"  name="form" id="form" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="openTime" name="openTime" placeholder="00:00" value="">                     
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="closeTime" name="closeTime" placeholder="00:00" value="">                     
                      <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-clock"></i></span>
                      </div>                      
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control mb-3" type="text" value="Việt Nam" readonly="readonly">
                    </div>
                    <div class="form-group">
