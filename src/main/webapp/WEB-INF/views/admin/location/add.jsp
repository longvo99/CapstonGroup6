                ...
                <div class="card-body">
                  <form role="form" method="post"  name="form" id="form" enctype="multipart/form-data">
					...
					<div class="form-group">
      				...
      				<div class="form-group">
                      <label for="locationName">src Iframe (map)</label>
                      <input class="form-control mb-3" type="text" value="" id="srciframe" name="srciframe">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<textarea class="form-control mb-10" id="description" rows="5" name="description"></textarea>
					</div>
					<script>
					    var editor = CKEDITOR.replace('description'); //detail là id của textarea cần tích hợp vào
					</script>
                    <div class="form-group">
