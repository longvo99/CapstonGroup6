              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <c:if test="${userDetail.user.role.roleId eq 'ADMIN'}">
                    ...
                    <input class="form-control mb-3" type="hidden" value="${location.users.userId}" name="users.userId">
                  ...
                  <%--  <div class="form-group">
					...
					<div class="form-group">
						...
						<textarea ${readonly} class="form-control mb-10" id="description" rows="5" name="description">${location.description}</textarea>
					</div>
					<script>
					...
					<div class="form-group">
                      ...
                      <input ${readonly} class="form-control mb-3" type="text" value="${location.srciframe}" id="srciframe" name="srciframe">
                    </div>
			<script>
