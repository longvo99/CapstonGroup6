						...
						<div class="card-body">
							...
							<form role="form" action="${actionUrl}" method="post" id="form"
								...
								<input type="hidden" value="${product.productId}" id="productId"
									...
									value="${product.orderCount}" id="orderCount" name="orderCount">
								<input type="hidden" value="${product.location.locationId}"
									id="locationId" name="location.locationId">
								<div class="form-group">
								...
								<div class="form-group">
									<label for="">Loại sản phẩm</label> <select
										class="form-control" id="productCategory.productCategoryId"
										...
										<c:if test="${not empty productCategoryList}">
											<c:forEach items="${productCategoryList}"
												...
												<c:choose>
													<c:when
														test="${productCategory.productCategoryId eq product.productCategory.productCategoryId}">
														<c:set var="selected" value="selected='selected'" />
													</c:when>
													<c:otherwise>
														<c:set var="selected" value="" />
												...
												<option ${selected}
													value="${productCategory.productCategoryId}">${productCategory.productCategoryName}</option>
											</c:forEach>
										</c:if>
									</select>
								</div>
								<div class="form-group">
									...
									<div class="input-group my-3">
										<input type="text" class="form-control"
											value="${product.imagePath}" readonly="readonly"
