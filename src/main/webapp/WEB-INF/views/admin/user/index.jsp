                    ...
                    <c:if test="${userDetail.user.role.roleId eq 'ADMIN'}">
						...
						<tr class="odd gradeX">
							...
							<td class="center text-center">
								...
								<c:if test="${user.role.roleId eq 'ADMIN'}">
									<a href="${urlEdit}" class="btn btn-sm btn-primary"><i class="fa fa-edit">Edit</i></a>
								</c:if>
                                <a href="${urlDel}" title="Xóa" class="btn btn-sm btn-danger"><i class="fa fa-trash"> Xóa </i></a>
							</td>
						</tr>
						<!-- Modal Center -->
			          <div class="modal fade" id="exampleModalCenter${user.userId}" tabindex="-1" role="dialog"
			            ...
			            <div class="modal-dialog modal-dialog-centered" role="document">
			              <div class="modal-content">
			                ...
			                <form role="form" action="${pageContext.request.contextPath}/admin/user/setbaned" method="post">
			                	<div class="comment-form">
					                    ...
					                    <div class="form-group">
					                      ...
					                      <input class="form-control mb-3" type="text" value="${fn:substring(user.dateOfBirth, 0, fn:indexOf(user.dateOfBirth, ' '))}" id="dateOfBirth" name="dateOfBirth" readonly>
					                    </div>
					                    <div class="form-group">
					                      <label for="district">Ngày tạo tài khoản</label>
					                      <input class="form-control mb-3" type="text" value="${fn:substring(user.joinDate, 0, fn:indexOf(user.joinDate, ' '))}" id="joinDate" name="joinDate" readonly>
					                    </div>
					                    <div class="form-group">
					                      <label for="ward">Mô tả</label>
										  <textarea disabled="disabled" class="form-control mb-3" rows="3">${user.description}</textarea>	
					                    </div>
					                    <c:if test="${user.role.roleId ne 'ADMIN'}">
					                    <div class="form-group">
					                      <label for="city">Trạng thái tài khoản</label>
					                      <select name="banned" class="form-control input-lg">
										    	<c:if test="${user.banned}">
										    		<option selected="selected" value="true" >Đã khóa</option>
										    		<option value="false" >Đang hoạt động</option>
										    	</c:if>
										    	<c:if test="${!user.banned}">
										    		<option value="true" >Đã khóa</option>
										    		<option selected="selected" value="false" >Đang hoạt động</option>
										    	</c:if>
										   </select>
					                    </div>
					                    </c:if>
					                    <div class="form-group">
					                      ...
					                      <input name="roleId" class="form-control mb-3" type="text" value="${user.role.roleId}" readonly>
					                    </div>
					                     <div class="form-group">
					                     	<label>Ảnh</label>
			              ...
			              <div class="modal-content">
			                ...
			                <div class="modal-body">
			                	<div class="comment-form">
					                    ...
					                    <div class="form-group">
					                      <label for="country">Chức vụ</label>
					                      <input class="form-control mb-3" type="text" value="${user.role.roleName}" readonly>
					                    </div>
					                     <div class="form-group">
					                     	<label>Ảnh</label>
					                      	<img src="${pageContext.request.contextPath}/resources/admin/assets/img/uploads/${user.avatarPath}" id="blah" alt="your image" style="max-height: 300px; display:block; margin-top: 15px; " />
