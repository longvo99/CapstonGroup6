                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="about.html" class="text-light-white fw-500">About Us</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="history-title mb-md-40">
                        <h2 class="text-light-black">A History Has Written For foodmart Explore <span class="text-light-green">more Our Story</span></h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-sm-6 col-md-6">
                            <div class="histry-img mb-xs-20">
                                <img src="https://via.placeholder.com/255x200" class="img-fluid full-width" alt="Histry">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-md-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="ad-img p-relative">
                        <img src="https://via.placeholder.com/1110x350" class="img-fluid full-width" alt="#">
                        <div class="overlay">
        ...
        <div class="u-line instagram-slider swiper-container">
            <ul class="hm-list hm-instagram swiper-wrapper">
                <li class="swiper-slide">
                    <a href="#">
                        <img src="https://via.placeholder.com/250x200" alt="instagram">
                    </a>
                </li>
                <li class="swiper-slide">
                    <a href="#">
                    ...
                    <div class="footer-contact">
                        ...
                        <form class="subscribe_form">
                            <div class="input-group">
                                <input type="text" class="form-control form-control-submit" name="email" placeholder="Enter your email"> <span class="input-group-btn">
    ...
    <div class="copyright">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 text-center medewithlove align-self-center"> <a href="http://www.Slidesigma.com" class="text-light-black">Made with Real <i class="fas fa-heart"></i> Slidesigma</a>
                </div>
                <div class="col-lg-4">
