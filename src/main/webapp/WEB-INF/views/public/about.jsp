						...
						<div class="row justify-content-start">
							<div class="col-lg-7 align-self-center">
								<div class="right-side-content">
									<h1 class="text-custom-white fw-600">Increase takeout
										sales by 50%</h1>
									<h3 class="text-custom-white fw-400">with the largest
										delivery platform in the U.S. and Canada</h3>
									<a href="restaurant.html" class="btn-second btn-submit">Learn
										More.</a>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-6">
					<div class="history-title mb-md-40">
						<h2 class="text-light-black">
							A History Has Written For foodmart Explore <span
								class="text-light-green">more Our Story</span>
						</h2>
						...
						<a class="btn-second btn-submit" href="#"> Our History </a>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="row align-items-center">
						<div class="col-lg-6 col-sm-6 col-md-6">
							<div class="histry-img mb-xs-20">
								<img src="https://via.placeholder.com/255x200"
									class="img-fluid full-width" alt="Histry">
							</div>
						</div>
						<div class="col-lg-6 col-sm-6 col-md-6">
			...
			<div class="row">
					...
					<div class="how-it-works-box arrow-1">
						<div class="how-it-works-box-inner">
							<span class="icon-box"> <img
								src="assets/img/001-search.png" alt="icon"> <span
								class="number-box">01</span>
							</span>
							<h6>Search</h6>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="how-it-works-box arrow-2">
						<div class="how-it-works-box-inner">
							<span class="icon-box"> <img
								src="assets/img/004-shopping-bag.png" alt="icon"> <span
								class="number-box">02</span>
							</span>
							<h6>Select</h6>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
								sed do eiusmod tempor incididunt ut.</p>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="how-it-works-box arrow-1">
						<div class="how-it-works-box-inner">
							<span class="icon-box"> <img
								src="assets/img/002-stopwatch.png" alt="icon"> <span
								class="number-box">03</span>
							</span>
							<h6>Order</h6>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
								sed do eiusmod tempor incididunt ut.</p>
				...
				<div class="col-lg-3 col-sm-6">
					<div class="how-it-works-box">
						<div class="how-it-works-box-inner">
							<span class="icon-box"> <img
								src="assets/img/003-placeholder.png" alt="icon"> <span
								class="number-box">04</span>
							</span>
							<h6>Enjoy</h6>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
								sed do eiusmod tempor incididunt ut.</p>
								...
								<div class="overlay padding-20">
									<div class="blog-meta">
										...
										<a href="blog-details.html"
											class="text-custom-white fw-700 fs-18">Read More</a>
									</div>
								</div>
								<div class="overlay overlay-bg"></div>
							</div>
							...
							<div class="blog-list padding-tb-10">
									...
									<div class="content-wrap">
										...
										<h6 class="entry-title no-margin">
											<a href="blog-details.html" class="text-light-black">How
												We designed It: pizza delivery from the ground up only for
												you.</a>
										</h6>
									</div>
									<div class="thumb-img">
								...
								<article class="side-post padding-20 u-line">
									<div class="content-wrap">
										...
										<h6 class="entry-title no-margin">
											<a href="blog-details.html" class="text-light-black">How
												We Made It: Grimaldi's traditional New York-style pizza
												italian style</a>
										</h6>
									</div>
									<div class="thumb-img">
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="feedback-item-two">
									...
									<p class="text-custom-white fs-16">I like foodmart and as
										compared to other company it's polices and customers support
										is very good easy to reach., also many time they unable to
										delivered. Quis ipsum suspendisse ultrices gravida. Risus
										commodo viverra maecenas accumsan lacus vel facilisist amet,
										sed do eiusm.</p>
									<h4 class="text-custom-white fw-600 no-margin">Janadhon
										doe</h4>
