                                                            ...
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    <li><a href="restaurant.html" class="text-light-white fw-500">Restaurant</a>
                                                                        ...
                                                                        <li class="active"><a href="add-restaurant.html" class="text-light-white fw-500">Add Restaurant</a>
                                                                        </li>
                                                    ...
                                                    <div class="col-xl-6 col-lg-12 col-md-6">
                                                        <div class="package-box main-box mb-lg-20">
                                                            <div class="package-img">
                                                                <a href="#">
                                                                    <img src="https://via.placeholder.com/432x233" class="img-fluid full-width" alt="package image">
                                                                </a>
                                                            </div>
                                            ...
                                            <div class="thankmsg-sec">
                                                <div class="msg-wrapper text-center">
                                                    <div class="wrapper-1 bg-black padding-20 mb-xl-20">
                                                        ...
                                                        <p class="text-custom-white">You have successfully created your restaurent, to add more details, go to your email inbox for login details</p>
                                                    </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="large-product-box p-relative pb-0">
                                    <img src="https://via.placeholder.com/446x700" class="img-fluid full-width" alt="image">
