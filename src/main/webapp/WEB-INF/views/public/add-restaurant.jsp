...
<title>foodmart | Add Restaurant</title>
<!-- Fav and touch icons -->
														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																...
																<ul>
																	...
																	<li class="active"><a href="add-restaurant.html"
							...
							<div class="row">
								<div class="col-xl-4 col-lg-5 mb-md-40">
									<ul class="step-steps steps-1">
										<li class="stepbtn active" id="step1"><a href="#"> <span
												class="number"></span> <span class="step-name">General
													Info</span>
										</a></li>
										<li class="stepbtn" id="step2"><a href="#"> <span
												class="number"></span> <span class="step-name">Select
													Package</span>
										</a></li>
										<li class="stepbtn" id="step3"><a href="#"> <span
												class="number"></span> <span class="step-name">Payment</span>
										</a></li>
										<li class="stepbtn" id="step4"><a href="#"> <span
												class="number"></span> <span class="step-name">Save &
													Preview</span>
										</a></li>
									</ul>
									<ul class="step-steps steps-2">
										<li class="add-res-tab active" id="stepbtn1"><a href="#"
											class="add-res-tab">General Info</a></li>
										<li class="add-res-tab" id="stepbtn2"><a href="#"
											class="add-res-tab">Select Package</a></li>
										<li class="add-res-tab" id="stepbtn3"><a href="#"
											class="add-res-tab">Payment</a></li>
										<li class="add-res-tab" id="stepbtn4"><a href="#"
											class="add-res-tab">Save & Preview</a></li>
									</ul>
										...
										<div class="step-tab-panel active" id="steppanel1">
											<div class="general-sec">
												<form>
													<div class="row">
														<div class="col-12">
															<h5 class="text-light-black fw-700">General
																Information</h5>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">Restaurant
																	name <sup class="fs-16">*</sup>
														...
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">Restaurant
																	phone</label> <input type="text" name="#"
																	class="form-control form-control-submit"
														...
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">Manager
																	Name</label> <input type="text" name="#"
																	class="form-control form-control-submit"
																	placeholder="i.e Alard Willaim">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">Manager
																	Contact phone</label> <input type="text" name="#"
																	class="form-control form-control-submit"
																	placeholder="i.e +1 321 828 6662">
															</div>
														</div>
														<div class="col-md-12">
															<div class="form-group">
																<label class="text-light-black fw-700">Contact
																	Email</label> <input type="email" name="#"
																	class="form-control form-control-submit"
													...
													<div class="row">
														...
														<div class="col-12">
															<div class="form-group">
																<label class="text-light-black fw-700">Country <sup
																	class="fs-16">*</sup>
																</label> <select
																	...
																	<option value="united-kingdom" data-name="">United
																		Kingdom</option>
																	<option value="united-states" data-name="">United
																		States</option>
																</select>
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">State</label> <select
																	class="form-control form-control-submit custom-select-2 full-width">
														...
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">City</label> <select
																	class="form-control form-control-submit custom-select-2 full-width">
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<input type="text" name="#"
																	class="form-control form-control-submit"
																	value="-3.7037901999999576">
															</div>
														</div>
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">Find On
																	Map</label> <input type="text" name="#"
																	class="form-control form-control-submit"
														...
														<div class="col-md-6">
															<div class="form-group">
																...
																<button type="submit" class="btn-second btn-submit">Search
																	Location</button>
															</div>
														</div>
														<div class="col-md-12">
													...
													<div class="row">
														...
														<div class="col-md-12">
															<div class="form-group">
																<label class="text-light-black fw-700">Cuisines
																	<sub>*</sub>
													...
													<div class="row">
														<div class="col-12">
															<h5 class="text-light-black fw-700">Account
																Information</h5>
														</div>
														<div class="col-md-6">
															<div class="form-group">
														...
														<div class="col-md-6">
															<div class="form-group">
																<label class="text-light-black fw-700">Email</label> <input
																	type="email" class="form-control form-control-submit"
													...
													<div class="row">
														<div class="col-12">
															<label class="custom-checkbox text-light-black fw-700">
																...
																class="checkmark"></span>By Registering You Confirm That
																You Accept The Terms & Conditions And Privacy Policy
															</label>
														</div>
													</div>
												</form>
												...
												<div class="row">
													<div class="col-xl-6 col-lg-12 col-md-6">
														<div class="package-box main-box mb-lg-20">
															<div class="package-img">
																<a href="#"> <img
																	src="https://via.placeholder.com/432x233"
																	class="img-fluid full-width" alt="package image">
																</a>
															</div>
															<div class="package-caption padding-20 bg-black">
																<div class="package-item-first">
																	<div class="pack-type fs-18 text-custom-white">Silver
																		Package</div>
																	<div class="pack-type fs-18 text-light-green">$
																		18</div>
																</div>
																<ul>
																	<li class="text-custom-white"><span>10 days</span>
																	</li>
																	<li class="text-custom-white"><span>1 dip
																			free (with every meal)</span></li>
																	<li class="text-custom-white"><span>1 Soft
																			drinks</span></li>
																	<li class="text-custom-white"><span>Unlimited
																			order</span></li>
																	<li class="text-custom-white"><span>Free
																			delivery</span></li>
																</ul>
																<div class="package-btn">
																	<a href="#" class="btn-second btn-submit full-width">Choose
																		Plan</a>
																</div>
															</div>
														</div>
													...
													<div class="col-xl-6 col-lg-12 col-md-6">
														<div class="package-box main-box">
															...
															<div class="package-caption padding-20 bg-black">
																<div class="package-item-first">
																	<div class="pack-type fs-18 text-custom-white">Gold
																		Package</div>
																	<div class="pack-type fs-18 text-light-green">$
																		35</div>
																</div>
																<ul>
																	...
																	<li class="text-custom-white"><span>2 dip
																			free (with every meal)</span></li>
																	<li class="text-custom-white"><span>3 Soft
																			drinks</span></li>
																	<li class="text-custom-white"><span>Unlimited
																			order</span></li>
																	<li class="text-custom-white"><span>Free
										...
										<div class="step-tab-panel" id="steppanel3">
											<div class="payment-sec">
												<div class="section-header-left">
													<h3 class="text-light-black header-title">Payment
														information</h3>
												</div>
												<div class="row">
													<div class="col-12">
														<div id="accordion">
															<div class="card">
																<div class="card-header">
																	<a class="collapsed card-link fw-500 fs-14"
																		data-toggle="collapse" href="#collapseOne"> Pay
																		with a Gift Card </a>
																</div>
																	...
																	<div class="card-body no-padding payment-option-tab">
																		<div class="form-group">
																			<div class="credit-card gift-card p-relative">
																				<input type="text" name="#"
																					class="form-control-submit fs-16" value="AC2B76">
																			</div>
																		</div>
																	</div>
																</div>
															...
															<div class="card">
																<div class="card-header">
																	<a class="collapsed card-link fw-500 fs-14"
																		data-toggle="collapse" href="#collapseTwo"> Add a
																		promo code </a>
																</div>
															...
															<div class="payment-option-tab">
																<ul class="nav nav-tabs">
																	<li class="nav-item"><a
																		class="nav-link fw-600 active" data-toggle="tab"
																		href="#savecreditcard">Saved credit card</a></li>
																	<li class="nav-item"><a class="nav-link fw-600"
																		data-toggle="tab" href="#newcreditcard">New credit
																			card</a></li>
																	<li class="nav-item"><a class="nav-link fw-600"
																		data-toggle="tab" href="#cash">Cash</a></li>
																	<li class="nav-item"><a class="nav-link fw-600"
																		data-toggle="tab" href="#paypal">PayPal<sup>TM</sup></a>
																	</li>
																	<li class="nav-item"><a class="nav-link fw-600"
																		data-toggle="tab" href="#amexcheckout">Amex
																...
																<div class="tab-content">
																	<div class="tab-pane active" id="savecreditcard">
																		...
																		<div class="section-header-left">
																			<h3 class="text-light-black header-title">Donate
																				the change</h3>
																		</div>
																		<div class="form-group">
																			<label class="custom-checkbox"> <input
																				type="checkbox" name="#"> <span
																				class="checkmark"></span> Donate $0.77 to No kid
																				Hungry. By checking this box you agree to the Donate
																				the Change <a href="#">Terms of use</a> <span
																		...
																		<p class="text-center text-light-black no-margin">
																			By placing your order, you agree to foodmart's <a
																		...
																		<div class="row">
																			...
																			<div class="col-xl-3 col-lg-6 col-md-3 col-sm-6">
																				<div class="form-group">
																					<label class="text-light-white fw-700">ZIP
																						Code</label> <input type="text" name="#"
																						class="form-control form-control-submit"
																						placeholder="123456">
																				</div>
																			</div>
																			<div class="col-12">
																				<div class="form-group">
																					<label class="custom-checkbox"> <input
																						type="checkbox" name="#"> <span
																						class="checkmark"></span> Save Credit card
																					</label>
																				</div>
																			</div>
																		</div>
																	...
																	<div class="tab-pane fade" id="cash">
																		<p class="text-light-black">Have the cash ready
																		...
																		<div class="form-group">
																			<label class="custom-checkbox"> <input
																				type="checkbox" name="#"> <span
																				class="checkmark"></span> Apologies, but you can't
																				donate with the selected payment type
																			</label>
																		</div>
																		<div class="form-group">
																			<button type="submit"
																	...
																	<div class="tab-pane fade" id="paypal">
																		<p class="text-light-black">Please review your
																			order and make any necessary changes before checking
																			out with PayPal.</p>
																		<div class="section-header-left">
																			<h3 class="text-light-black header-title">Donate
																				the change</h3>
																		...
																		<div class="form-group">
																			<button type="submit"
																				class="btn-first paypal-btn text-custom-white full-width fw-500">
																				Checkout with <img src="assets/img/pay-pal.png"
																					alt="image">
																			</button>
																		</div>
																		<p class="text-center text-light-black no-margin">
																	...
																	<div class="tab-pane fade" id="amexcheckout">
																		<div class="card">
																			<div class="card-header">
																				<a class="card-link fw-500 fs-14"
																					data-toggle="collapse" href="#saveamex"> Saved
																					Card </a>
																			</div>
																		...
																		<div class="card">
																			<div class="card-header">
																				<a class="collapsed card-link fw-500 fs-14"
																					data-toggle="collapse" href="#newcardamex"> Add
																					New Card </a>
																			</div>
											...
											<div class="thankmsg-sec">
												<div class="msg-wrapper text-center">
													<div class="wrapper-1 bg-black padding-20 mb-xl-20">
														...
														<h3 class="text-custom-white">We are looking forward
															for next order.</h3>
														<p class="text-custom-white">You have successfully
															created your restaurent, to add more details, go to your
															email inbox for login details</p>
													</div>
															...
															<div class="product-box mb-xl-20">
																...
																<div class="product-caption">
																	<div class="title-box">
																		...
																		<div class="tags">
																			<span
																				class="text-custom-white rectangle-tag bg-yellow">
																				3.1 </span>
																		</div>
																	</div>
																	...
																	<div class="product-details">
																		...
																		<div class="rating">
																			<span> <i class="fas fa-star text-yellow"></i>
																				<i class="fas fa-star text-yellow"></i> <i
														...
														<div class="col-md-6">
															<div class="product-box mb-xl-20">
																...
																<div class="product-caption">
																	...
																	<p class="text-light-white">Breakfast, Lunch &amp;
																		Dinner</p>
																	<div class="product-details">
																		<div class="price-time">
																			<span class="text-light-black time">30-40 min</span>
																	...
																	<div class="product-footer">
																		<span class="text-custom-white square-tag"> <img
																			src="assets/img/svg/007-chili-1.svg" alt="tag">
																		</span> <span class="text-custom-white square-tag"> <img
																			src="assets/img/svg/004-leaf.svg" alt="tag">
																		</span> <span class="text-custom-white square-tag"> <img
																			src="assets/img/svg/009-lemon.svg" alt="tag">
													...
													<p class="text-light-black">For cancellation or more
														information Please Contact Us</p>
													<ul class="contact-details">
														<li><i class="fas fa-phone-alt text-light-black"></i>
															<span><a href="tel:" class="text-light-black">(347)
																	123456789</a></span></li>
														<li><i class="fas fa-fax text-light-black"></i> <span><a
																href="tel:" class="text-light-black">(347) 123456789</a></span>
														</li>
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="large-product-box p-relative pb-0">
									<img src="https://via.placeholder.com/446x700"
									...
									<div class="overlay padding-20">
										...
										<div class="content-wrapper">
											<h3 class="text-custom-white">50% Discount on All New
												Restaurants</h3>
		...
		<div class="u-line instagram-slider swiper-container">
			<ul class="hm-list hm-instagram swiper-wrapper">
				<li class="swiper-slide"><a href="#"> <img
						src="https://via.placeholder.com/250x200" alt="instagram">
				</a></li>
				<li class="swiper-slide"><a href="#"> <img
						src="https://via.placeholder.com/250x200" alt="instagram">
				</a></li>
