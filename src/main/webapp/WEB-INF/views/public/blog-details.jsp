                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="blog-details.html" class="text-light-white fw-500">Blog Details</a>
                                                                    </li>
                    ...
                    <div class="main-box padding-20 full-width">
                        <div class="breadcrumb-wrpr">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="blog.html" class="text-light-black">Blog</a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Blog Details</li>
                            </ul>
                        </div>
                        <div class="post-wrapper mb-xl-20">
                            <img src="https://via.placeholder.com/822x337" class="img-fluid full-width" alt="#">
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="blog-meta mb-xl-20">
                                    <h2 class="blog-title text-light-black">Best chinese restaurants in Brooklyn.</h2>
                                    <h6 class="text-light-white fs-14">Posted on 25 January, 2020</h6>
