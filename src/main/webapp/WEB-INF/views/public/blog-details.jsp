...
<title>foodmart | Blog Details</title>
<!-- Fav and touch icons -->
					...
					<div class="sidebar2">
						<div class="side-bar section-padding pb-0 mb-md-40">
								...
								<article class="side-post pb-xl-20 mb-xl-20 u-line">
									<div class="thumb-img">
										<a href="blog-details.html"> <img
											src="https://via.placeholder.com/100" alt="thumb-img">
										</a>
									</div>
									<div class="content-wrap">
										<div class="entry-meta-content">
											<h5 class="entry-title">
												<a href="blog-details.html" class="text-light-black">Chicken
													Dishes You Should Eat Based on Your Horoscope</a>
											</h5>
											<div class="entry-tye">
												<span class="text-light-green fw-600">20 Nov 2020</span>
											</div>
										</div>
									</div>
								</article>
							...
							<div class="main-box padding-20 blog-tags mb-xl-20">
								...
								<a href="#">#pizza</a> <a href="#">#hot dog</a> <a href="#">#fries</a>
								<a href="#">#fried chicken</a> <a href="#">#smoky chicken</a> <a
									href="#">#soup</a> <a href="#">#perry perry</a> <a href="#">#cryspy
									crunch</a> <a href="#">#green slad</a> <a href="#">#chocolawa</a> <a
									href="#">#butter bite</a> <a href="#">#chicken role</a> <a
									href="#">#salmon fish</a>
							</div>
							<div class="main-box padding-20 trending-blog-cat mb-xl-20">
								<h4 class="text-light-black">Categories</h4>
								<ul>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Pizza <span
											class="text-light-white fw-400">(110)</span></a></li>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Burger <span
											class="text-light-white fw-400">(98)</span></a></li>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Quick Noodles <span
											class="text-light-white fw-400">(52)</span></a></li>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Chilli Chicken <span
											class="text-light-white fw-400">(26)</span></a></li>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Spring Rolls <span
											class="text-light-white fw-400">(55)</span></a></li>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Chilli Potato <span
											class="text-light-white fw-400">(48)</span></a></li>
									<li class="pb-xl-20 u-line mb-xl-20"><a href="#"
										class="text-light-black fw-600">Chicken Soup <span
											class="text-light-white fw-400">(50)</span></a></li>
								...
								<div class="product-box mb-xl-20">
									<div class="product-img">
										<a href="restaurant.html"> <img
											src="https://via.placeholder.com/406x239"
						...
						<div class="breadcrumb-wrpr">
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.html"
									class="text-light-black">Home</a></li>
								<li class="breadcrumb-item"><a href="blog.html"
									class="text-light-black">Blog</a></li>
								<li class="breadcrumb-item active" aria-current="page">Blog
									Details</li>
							</ul>
						</div>
						<div class="post-wrapper mb-xl-20">
							<img src="https://via.placeholder.com/822x337"
								class="img-fluid full-width" alt="#">
						</div>
						<div class="row">
							<div class="col-12">
								<div class="blog-meta mb-xl-20">
									<h2 class="blog-title text-light-black">Best chinese
										restaurants in Brooklyn.</h2>
									<h6 class="text-light-white fs-14">Posted on 25 January,
										2020</h6>
									<p class="text-light-white">Lorem Ipsum is simply dummy
								...
								<div class="blog-meta mb-xl-20">
									<h5 class="blog-title text-light-black">Why do we choose
										it?</h5>
									<p class="text-light-white">It is a long established fact
								...
								<div class="blog-meta mb-xl-20">
									<h5 class="blog-title text-light-black">Where does it come
										from?</h5>
									<p class="text-light-white mb-xl-20">Contrary to popular
										...
										section 1.10.32.</p>
									<p class="text-light-white">The standard chunk of Lorem
								...
								<div class="blog-meta mb-xl-20">
									<h5 class="blog-title text-light-black">Where can I get
										that food?</h5>
									<p class="text-light-white">There are many variations of
								...
								<div class="blog-meta mb-xl-20">
									<h5 class="blog-title text-light-black">Why do we order
										from there?</h5>
									<p class="text-light-white">It is a long established fact
										that a reader will be distracted by the readable content of a
										page when looking at its layout. The point of using Lorem
								...
								<blockquote>
									<p>"Chinese is the popular dish, Lorem Ipsum is not simply
										random text. It has roots in a piece of classical chinese."</p>
								</blockquote>
								<div class="comment-box">
									...
									<div class="review-box">
										...
										<p class="text-light-black">Delivery was fast and
											friendly. Food was not great especially the salad. Will not
											be ordering from again. Too many options to settle for this
											place.</p>
									</div>
									...
									<div class="review-box comment-reply">
										...
										<div class="ratings">
											<span class="text-yellow fs-16"> <i
												...
												class="fas fa-star"></i>
											</span> <span class="ml-2 text-light-white">2 days ago <i
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label class="text-light-black fw-600">Full Name</label> <input
														type="text" name="#"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="text-light-black fw-600">Email
														Address</label> <input type="email" name="#"
														class="form-control form-control-submit"
											...
											<div class="col-md-12">
												<div class="form-group">
													...
													<textarea class="form-control form-control-submit" name="#"
														rows="6" placeholder="Your Comment"></textarea>
												</div>
												<button type="submit"
													class="btn-second btn-submit full-width">Send</button>
											</div>
										</div>
									</form>
								</div>
				...
				<aside class="col-lg-3">
					<div class="sidebar3">
						<div class="side-bar section-padding pb-0">
							<div
								class="advertisement-slider swiper-container h-auto mb-xl-20">
										...
										<div class="testimonial-wrapper">
											<div class="testimonial-box">
												...
												<div class="testimonial-caption padding-15">
													...
													<div class="testimonial-user-box">
														<img src="https://via.placeholder.com/40"
															class="rounded-circle" alt="restaurant.html">
														<div class="testimonial-user-name">
															<p class="text-light-black fw-600">Sarra</p>
															<i class="fas fa-trophy text-black"></i><span
																class="text-light-black">Top Reviewer</span>
							...
							<div class="large-product-box mb-xl-20">
								<img src="https://via.placeholder.com/446x1025"
							...
							<div class="inner-wrapper main-box">
								<div class="main-banner p-relative">
									<img src="https://via.placeholder.com/446x501"
										class="img-fluid full-width main-img" alt="banner">
									<div class="overlay-2 main-padding">
										<img src="https://via.placeholder.com/110x64"
											class="img-fluid" alt="logo">
									</div>
									<img src="https://via.placeholder.com/200x130"
										class="footer-img" alt="footerimg">
								</div>
								<div class="section-2 main-page main-padding">
									<div class="login-box">
										<h3 class="text-light-black fw-700">foodmart food
											delivery every time</h3>
