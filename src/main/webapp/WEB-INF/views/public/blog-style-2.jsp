                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    <li><a href="index.html" class="text-light-white fw-500">Landing Page</a>
                                                                    </li>
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="blog-style-2.html" class="text-light-white fw-500">Blog Grid View 2</a>
                                                                    </li>
                                ...
                                <article class="side-post pb-xl-20 mb-xl-20 u-line">
                                    <div class="thumb-img">
                                        <a href="blog-details.html">
                                            <img src="https://via.placeholder.com/100" alt="thumb-img">
                                        </a>
                                    </div>
                                    <div class="content-wrap">
                                        <div class="entry-meta-content">
                                            ...
                                            <div class="entry-tye"> <span class="text-light-green fw-600">20 Nov 2020</span>
                                            </div>
                                        </div>
                                    </div>
                                </article>
                                ...
                                <div class="product-box mb-xl-20">
                                    <div class="product-img">
                                        <a href="restaurant.html">
                                            <img src="https://via.placeholder.com/406x239" class="img-fluid full-width" alt="product-img">
                                        </a>
                                        <div class="overlay">
                ...
                <div class="col-lg-6 blog-inner clearfix">
                    <div class="main-box padding-20 full-width">
                        <div class="breadcrumb-wrpr">
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html" class="text-light-black">Home</a>
                                </li>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-12 col-sm-6">
                                <article class="blog-services-wrapper main-box mb-xl-20">
                                    <div class="post-img">
                                        <a href="blog-details.html">
                                            <img src="https://via.placeholder.com/426x311" class="img-fluid full-width" alt="image">
                                        </a>
                                    </div>
                                    <div class="post-meta">
                                        <div class="author-img">
                                            <img src="https://via.placeholder.com/50" class="rounded-circle" alt="image">
                                        </div>
                                        <div class="author-meta">
                                            <h6 class="no-margin"><a href="#" class="text-light-black">Charles C. Pruitt</a></h6>
                                            <p class="no-margin text-light-white"><a href="#" class="text-light-white">Admin</a> | 25 January , 2020</p>
                                        </div>
                                    </div>
                                    <div class="post-content padding-20">
                                        <h5><a href="blog-details.html" class="text-light-black">Best chinese restaurants in Brooklyn</a></h5>
                                        <p>It is a long established fact that a reader will be distracted by the readable...</p>
                                        <div class="blog-link-wrap"> <a href="blog-details.html" class="btn-first white-btn">Learn More</a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-xl-6 col-lg-12 col-sm-6">
                                <article class="blog-services-wrapper main-box mb-xl-20">
                                    ...
                                    <div class="post-content padding-20">
                                        <h5><a href="#" class="text-light-black">15 Best Italian food you must try</a></h5>
                                        <p>It is a long established fact that a reader will be distracted by the readable...</p>
                                        <div class="blog-link-wrap"> <a href="#" class="btn-first white-btn">Learn More</a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-xl-6 col-lg-12 col-sm-6">
                                <article class="blog-services-wrapper main-box mb-xl-20">
                                    ...
                                    <div class="post-content padding-20">
                                        <h5><a href="blog-details.html" class="text-light-black">Tomatoes Stuffed with Foie and Chanterelles</a></h5>
                                        <p>It is a long established fact that a reader will be distracted by the readable...</p>
                                        <div class="blog-link-wrap"> <a href="blog-details.html" class="btn-first white-btn">Learn More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-12 col-sm-6">
                                <article class="blog-services-wrapper main-box mb-xl-20">
                                    ...
                                    <div class="post-content padding-20">
                                        <h5><a href="blog-details.html" class="text-light-black">Chanterelle and Porcini Mushroom Recipes</a></h5>
                                        <p>It is a long established fact that a reader will be distracted by the readable...</p>
                                        <div class="blog-link-wrap"> <a href="blog-details.html" class="btn-first white-btn">Learn More</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-6 col-lg-12 col-sm-6">
                                <article class="blog-services-wrapper main-box mb-xl-20">
                                    ...
                                    <div class="post-content padding-20">
                                        <h5><a href="blog-details.html" class="text-light-black">15 Best Italian food you must try</a></h5>
                                        <p>It is a long established fact that a reader will be distracted by the readable...</p>
                                        <div class="blog-link-wrap"> <a href="blog-details.html" class="btn-first white-btn">Learn More</a>
                                        </div>
                                    </div>
                    ...
                    <div class="sidebar3">
                        <div class="side-bar section-padding pb-0">
                                    ...
                                    <div class="testimonial-wrapper">
                                        <div class="testimonial-box">
                                            ...
                                            <div class="testimonial-caption padding-15">
                                                ...
                                                <h5 class="fw-600"><a href="restaurant.html" class="text-light-black">GSA King Tomato Farm</a></h5>
                                                <div class="testimonial-user-box">
                                                    <img src="https://via.placeholder.com/40" class="rounded-circle" alt="restaurant.html">
                                                    <div class="testimonial-user-name">
                                                        <p class="text-light-black fw-600">Sarra</p> <i class="fas fa-trophy text-black"></i><span class="text-light-black">Top Reviewer</span>
                                                    </div>
                                                </div>
                            ...
                            <div class="large-product-box mb-xl-20">
                                <img src="https://via.placeholder.com/446x1025" class="img-fluid full-width" alt="image">
                            ...
                            <div class="inner-wrapper main-box">
                                <div class="main-banner p-relative">
                                    <img src="https://via.placeholder.com/446x501" class="img-fluid full-width main-img" alt="banner">
                                    <div class="overlay-2 main-padding">
                                        <img src="https://via.placeholder.com/110x64" class="img-fluid" alt="logo">
                                    </div>
                                    <img src="https://via.placeholder.com/200x130" class="footer-img" alt="footerimg">
                                </div>
                                <div class="section-2 main-page main-padding">
                                    <div class="login-box">
                                        <h3 class="text-light-black fw-700">foodmart food delivery every time</h3>
