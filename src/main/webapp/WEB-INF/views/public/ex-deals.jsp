                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="ex-deals.html" class="text-light-white fw-500">Ex Deals</a>
                                                                    </li>
            ...
            <div class="row section-padding-bottom u-line">
                <div class="col-md-7 align-self-center">
                    <div class="title">
                        <div class="deals-heading">
                            ...
                            <p class="text-light-black">foodmart deals, coupons, promos, and more</p>
                ...
                <div class="col-md-5">
                    <div class="deals-image">
                        <img src="https://via.placeholder.com/445x193" class="img-fluid full-width" alt="#">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="featured-product">
                                    <div class="featured-img">
                                        ...
                                        <div class="overlay-2 padding-10"> <span class="deal-tag">Only on foodmart</span>
                                        </div>
                                    </div>
    ...
    <section class="local-deals section-padding">
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="product-box mb-xl-20">
                        <div class="product-box-2">
                            <div class="product-img">
                                <a href="restaurant.html">
                                    <img src="https://via.placeholder.com/88x112" class="img-fluid" alt="product-img">
                                </a>
                            </div>
                            <div class="product-caption">
                                <div class="title-box">
            ...
            <div class="row justify-content-md-center">
                <div class="col-md-2"> <a href="restaurant.html" class="btn-first white-btn text-light-green fw-600">See More</a>
                </div>
            </div>
        </div>
    </section>
