														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																...
																<ul>
																	...
																	<li class="active"><a href="ex-deals.html"
			...
			<div class="row section-padding-bottom u-line">
				<div class="col-md-7 align-self-center">
					<div class="title">
						<div class="deals-heading">
							<h2 class="text-light-black fw-700">Discover exclusive deals
								with Perks</h2>
							<p class="text-light-black">foodmart deals, coupons, promos,
								and more</p>
							<a href="ex-deals.html" class="btn-second btn-submit">View
								Deals</a>
						</div>
					</div>
				</div>
				<div class="col-md-5">
					<div class="deals-image">
						<img src="https://via.placeholder.com/445x193"
								...
								<div class="featured-product">
									<div class="featured-img">
										<a href="restaurant.html"> <img
											src="https://via.placeholder.com/360x178"
											class="img-fluid full-width" alt="#">
										</a>
										<div class="overlay-2 padding-10">
											<span class="deal-tag">Only on foodmart</span>
										</div>
									</div>
									<div class="featured-product-details">
										<div class="pro-logo">
											<img src="https://via.placeholder.com/64" class="img-fluid"
												alt="#">
										</div>
										<div class="pro-title">
											<h6 class="mb-1">
												<a href="restaurant.html" class="text-light-black fw-600">Great
													Burger</a>
											</h6>
											<p class="text-light-white fs-12 mb-1">American, Fast
												Food</p>
											<span class="text-orange">Closed. Next delivery at
												8:30am.</span>
										</div>
									</div>
								</div>
							...
							<div class="swiper-slide">
								<div class="featured-product">
									...
									<div class="featured-product-details">
										...
										<div class="pro-title">
											<h6 class="mb-1">
												<a href="restaurant.html" class="text-light-black fw-600">Flavor
													Town</a>
											</h6>
											<p class="text-light-white fs-12 mb-1">Breakfast, Lunch &
												Dinner</p>
											<span class="text-orange">Closed. Next delivery at
												8:30am.</span>
										</div>
							...
							<div class="swiper-slide">
								<div class="featured-product">
									...
									<div class="featured-product-details">
										...
										<div class="pro-title">
											<h6 class="mb-1">
												<a href="restaurant.html" class="text-light-black fw-600">Big
													Bites</a>
											</h6>
											<p class="text-light-white fs-12 mb-1">Pizzas, Fast Food</p>
											<span class="text-orange">Closed. Next delivery at
												8:30am.</span>
										</div>
									</div>
							...
							<div class="swiper-slide">
								<div class="featured-product">
									...
									<div class="featured-product-details">
										...
										<div class="pro-title">
											<h6 class="mb-1">
												<a href="restaurant.html" class="text-light-black fw-600">Smile
													N’ Delight</a>
											</h6>
											<p class="text-light-white fs-12 mb-1">Desserts,
												Beverages</p>
											<span class="text-orange">Closed. Next delivery at
												8:30am.</span>
										</div>
			...
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						...
						<p class="text-light-black">Explore deals at the most popular
							spots</p>
					</div>
				</div>
				<div class="col-12">
			...
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						...
						<p class="text-light-black">Find new Restaurants with deals
							near you</p>
					</div>
				</div>
				<div class="col-12">
				...
				<div class="col-lg-4 col-md-6">
					<div class="product-box mb-xl-20">
						<div class="product-box-2">
							<div class="product-img">
								<a href="restaurant.html"> <img
									src="https://via.placeholder.com/88x112" class="img-fluid"
									alt="product-img">
								</a>
							</div>
							<div class="product-caption">
			...
			<div class="row justify-content-md-center">
				<div class="col-md-2">
					<a href="restaurant.html"
						class="btn-first white-btn text-light-green fw-600">See More</a>
				</div>
			</div>
		</div>
	</section>
