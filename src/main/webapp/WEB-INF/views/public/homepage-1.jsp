...
<title>foodmart | Homepage 1</title>
<!-- Fav and touch icons -->
														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																...
																<ul>
																	...
																	<li class="active"><a href="homepage-1.html"
			...
			<div class="row no-gutters">
				...
				<div class="col-md-6">
					<div class="section-2 main-page main-padding">
						<div class="top-nav">
							<h5>
								<a href="ex-deals.html" class="text-light-green fw-700">Explore</a>
							</h5>
							<h5>
								<a href="login.html" class="text-light-green fw-700">Sign in</a>
							</h5>
						</div>
						<div class="login-box">
							<div class="col-12">
								<h1 class="text-light-black fw-700">foodmart food delivery
									every time</h1>
