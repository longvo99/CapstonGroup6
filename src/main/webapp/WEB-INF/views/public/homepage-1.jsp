                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="homepage-1.html" class="text-light-white fw-500">Home Page 1</a>
                                                                    </li>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-6">
                    <div class="section-2 main-page main-padding">
                        <div class="top-nav">
                            <h5><a href="ex-deals.html" class="text-light-green fw-700">Explore</a></h5>
                            <h5><a href="login.html" class="text-light-green fw-700">Sign in</a></h5>
                        </div>
                        <div class="login-box">
                            <div class="col-12">
                                <h1 class="text-light-black fw-700">foodmart food delivery every time</h1>
                    ...
                    <div class="product-box mb-md-20">
                        <div class="product-img">
                            <a href="restaurant.html">
                                <img src="https://via.placeholder.com/255x104" class="img-fluid full-width" alt="product-img">
                            </a>
                        </div>
