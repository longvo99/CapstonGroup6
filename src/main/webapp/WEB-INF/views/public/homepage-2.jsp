...
<title>foodmart | Homepage 2</title>
<!-- Fav and touch icons -->
														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																...
																<ul>
																	...
																	<li class="active"><a href="homepage-2.html"
					...
					<div class="col-lg-6">
						<div class="content-wrapper bg-white padding-20">
							<div class="content-box padding-tb-10">
								<h2 class="text-light-black fw-700">Find New York City
									restaurants near you and order online for free.</h2>
								<label class="text-light-black fw-700">Find a location
									near you</label>
								<div class="input-group row">
									...
									<div class="input-group-append col-xl-4">
										<button class="btn-second btn-submit full-width" type="button">Find
											food</button>
									</div>
								</div>
							</div>
					...
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">
							Browse by cuisine <span class="fs-14"><a
								href="restaurant.html">See all restaurant</a></span>
						</h3>
					</div>
				</div>
				<div class="col-12">
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">
							Your previous orders <span class="fs-14"><a
								href="order-details.html">See all past orders</a></span>
						</h3>
					</div>
				</div>
					...
					<div class="product-box mb-md-20">
						<div class="product-img">
							<a href="restaurant.html"> <img
								src="https://via.placeholder.com/255x104"
								class="img-fluid full-width" alt="product-img">
							</a>
						</div>
						<div class="product-caption">
							<h6 class="product-title">
								<a href="restaurant.html" class="text-light-black "> Chilli
									Chicken Pizza</a>
							</h6>
							<p class="text-light-white">Big Bites, Brooklyn</p>
							<div class="product-btn">
								<a href="order-details.html"
									class="btn-first white-btn full-width text-light-green fw-600">Track
									Order</a>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="product-box mb-md-20">
						...
						<div class="product-caption">
							<h6 class="product-title">
								<a href="restaurant.html" class="text-light-black "> Hakka
									Noodles</a>
							</h6>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="product-box mb-md-20">
						...
						<div class="product-caption">
							<h6 class="product-title">
								<a href="restaurant.html" class="text-light-black "> Vegan
									Burger </a>
							</h6>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="product-box mb-md-20">
						...
						<div class="product-caption">
							<h6 class="product-title">
								<a href="restaurant.html" class="text-light-black "> Sticky
									Date Cake</a>
							</h6>
		...
		<div class="row">
			<div class="col-12">
				<div id="banner-adv2" class="banner-adv2">
					<img src="https://via.placeholder.com/1110x100"
						class="img-fluid full-width" alt="banner"> <span
						class="text">Unlimited Free Delivery with. <img
						src="https://via.placeholder.com/105x30" alt="logo"> <a
						href="restaurant.html" class="btn-second btn-submit">Try 30
							Days FREE</a></span> <span class="close-banner"></span>
					<div class="overlay overlay-bg"></div>
				</div>
			</div>
		</div>
	...
	<section class="ex-collection section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">Explore our
							collections</h3>
					</div>
				</div>
			</div>
