...
<title>foodmart | Homepage 3</title>
<!-- Fav and touch icons -->
														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																...
																<ul>
																	...
																	<li class="active"><a href="homepage-3.html"
			...
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">Kosher
							Delivery</h3>
					</div>
				</div>
				<div class="col-12">
							...
							<div class="swiper-slide">
								<div class="product-box-3">
									<div class="product-img">
										<a href="#"> <img
											src="https://via.placeholder.com/604x240"
									...
									<div class="product-caption">
										<div class="padding-tb-10">
											<h5 class="mb-1">
												<a href="#" class="text-light-black">foodmart®
													(Fillmore)</a>
											</h5>
											<ul class="food-type">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="ex-collection-box mb-xl-20">
								<img src="https://via.placeholder.com/604x336"
					...
					<div class="row">
						<div class="col-lg-3">
							<div class="large-product-box p-relative pb-0">
								<img src="https://via.placeholder.com/287x702"
									class="img-fluid full-width" alt="image">
								<div class="category-type overlay padding-15">
				...
				<div class="col-lg-3">
					...
					<div class="advertisement-slider swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="large-product-box p-relative pb-0">
									<img src="https://via.placeholder.com/475x1225"
										class="img-fluid full-width" alt="image">
			...
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						...
						<h3 class="text-light-black header-title title">Specialized
							Food</h3>
					</div>
				</div>
				<div class="col-12">
				...
				<div class="col-12">
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">
							Food Near Me <span class="fs-14"><a href="restaurant.html">View
									All</a></span>
						</h3>
					</div>
				</div>
						...
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<a href="restaurant.html" class="categories">
									...
									</div> <span class="text-light-black cat-name">Chicken Special
										Pizza</span>
								</a>
							</div>
							<div class="swiper-slide">
							...
							<div class="swiper-slide">
								<a href="restaurant.html" class="categories">
									<div class="icon icon2 text-custom-white bg-light-green ">
										<img src="https://via.placeholder.com/220x220"
											class="rounded-circle" alt="categories">
									</div> <span class="text-light-black cat-name">Sticky Date
										Cake</span>
								</a>
							</div>
							<div class="swiper-slide">
								<a href="restaurant.html" class="categories">
									<div class="icon icon2 text-custom-white bg-light-green ">
										<img src="https://via.placeholder.com/220x220"
											class="rounded-circle" alt="categories">
									</div> <span class="text-light-black cat-name">Thai Dumpling
										Soup</span>
								</a>
							</div>
							<div class="swiper-slide">
								<a href="restaurant.html" class="categories">
									<div class="icon icon2 text-custom-white bg-light-green ">
										<img src="https://via.placeholder.com/220x220"
											class="rounded-circle" alt="categories">
									</div> <span class="text-light-black cat-name">American Chop
										Suey</span>
								</a>
							</div>
							<div class="swiper-slide">
								<a href="restaurant.html" class="categories">
									<div class="icon icon2 text-custom-white bg-light-green ">
										<img src="https://via.placeholder.com/220x220"
											class="rounded-circle" alt="categories">
									</div> <span class="text-light-black cat-name"> Italian
										Sausage Pasta </span>
								</a>
							</div>
							<div class="swiper-slide">
							...
							<div class="swiper-slide">
								<a href="restaurant.html" class="categories">
									<div class="icon icon2 text-custom-white bg-light-green ">
										<img src="https://via.placeholder.com/220x220"
											class="rounded-circle" alt="categories">
									</div> <span class="text-light-black cat-name">Mexican Street
										Tacos</span>
								</a>
							</div>
						</div>
