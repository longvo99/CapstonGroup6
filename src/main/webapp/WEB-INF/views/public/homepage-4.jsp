...
<title>foodmart | Homepage 4</title>
<!-- Fav and touch icons -->
														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																...
																<ul>
																	...
																	<li class="active"><a href="homepage-4.html"
															...
															<div class="menu-style">
																...
																<ul>
																	<li><a href="restaurant.html"
																		class="text-light-white fw-500">restaurent</a>
																	<li><a href="restaurant-style-1.html"
																		class="text-light-white fw-500">restaurent 1</a></li>
																	<li><a href="restaurant-style-2.html"
																		class="text-light-white fw-500">restaurent 2</a></li>
																	<li><a href="add-restaurant.html"
																		class="text-light-white fw-500">Add restaurent</a></li>
				...
				<div class="row">
					<div class="col-lg-7 align-self-center">
						<div class="right-side-content">
							<h1 class="text-custom-white fw-600">Increase takeout sales
								by 50%</h1>
							<h3 class="text-custom-white fw-400">with the largest
								delivery platform in the U.S. and Canada</h3>
						</div>
					</div>
					<div class="col-lg-5">
						<div class="content-wrapper bg-white padding-20">
							<div class="content-box padding-tb-10 text-center">
								<h3 class="text-light-black fw-700">Get started with
									foodmart today!</h3>
								<form>
									<div class="row">
										<div class="col-12">
											...
											<div class="form-group">
												<button type="submit"
													class="btn-second btn-submit full-width">Get
													Started</button>
											</div>
										</div>
									</div>
	...
	<section class="browse-cat browse-cat-2 u-line section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">
							Browse by cuisine <span class="fs-14"><a
								href="restaurant.html">See all restaurent</a></span>
						</h3>
					</div>
				</div>
				<div class="col-lg-2 col-sm-4 col-6">
					<a href="#" class="categories mb-md-20">
						<div class="icon text-custom-white bg-light-green ">
							<img src="https://via.placeholder.com/160x160"
								class="img-fluid full-width" alt="categories">
							<div class="overlay">
								<div class="product-addbtn">
									<span class="add-product"><i class="fas fa-plus"></i></span>
								</div>
							</div>
				...
				<div class="col-lg-2 col-sm-4 col-6">
					<a href="restaurant.html" class="categories mb-md-20">
						<div class="icon text-custom-white bg-light-green ">
							<img src="https://via.placeholder.com/160x160"
								class="img-fluid full-width" alt="categories">
							<div class="overlay">
				...
				<div class="col-lg-2 col-sm-4 col-6">
					<a href="restaurant.html" class="categories mb-sm-20">
						<div class="icon text-custom-white bg-light-green ">
							<img src="https://via.placeholder.com/160x160"
								class="img-fluid full-width" alt="categories">
							<div class="overlay">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="ex-collection-box mb-xl-20">
						<img src="https://via.placeholder.com/540x300"
							class="img-fluid full-width" alt="image">
						<div class="category-type overlay padding-15">
							<a href="restaurant.html" class="category-btn">Top rated</a>
						</div>
					</div>
				</div>
				<div class="col-md-6">
						...
						<div class="product-caption">
							...
							<div class="product-details">
								...
								<div class="rating">
									...
									</span> <span class="text-light-white text-right">4225 ratings</span>
								</div>
							</div>
				...
				<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
					<div class="product-box">
						...
						<div class="product-caption">
							<div class="title-box">
								<h6 class="product-title">
									<a href="restaurant.html" class="text-light-black "> Choice
										Foods</a>
								</h6>
								<div class="tags">
									<span class="text-custom-white rectangle-tag bg-green">
					...
					<div class="blog-box">
						...
						<article class="post">
							<div class="blog-img p-relative">
								<a href="#"> <img src="https://via.placeholder.com/740x442"
									alt="blog-img">
								</a>
								<div class="overlay padding-20">
									<div class="blog-meta">
										<h4 class="text-custom-white mb-2 fw-600">New locations
											where you can now get your foodmart® delivered</h4>
										<a href="#" class="text-custom-white fw-700 fs-18">Read
											More</a>
									</div>
								</div>
								<div class="overlay overlay-bg"></div>
								...
								<article class="side-post padding-20 u-line">
									<div class="content-wrap">
										...
										<h6 class="entry-title no-margin">
											<a href="blog-details.html" class="text-light-black">How
												We Made It: Grimaldi's traditional New York-style pizza</a>
										</h6>
									</div>
									<div class="thumb-img">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="ad-img p-relative">
						<img src="https://via.placeholder.com/1110x350"
							class="img-fluid full-width" alt="restaurant.html">
						<div class="overlay">
							<div class="content-box transform-center">
								<p class="text-custom-white">foodmart</p>
								<h3 class="text-custom-white mb-1">More than 3000
									restaurents</h3>
								<h5 class="text-custom-white">Book a table easly at the
									best price</h5>
								<a href="restaurant.html" class="btn-first white-btn">View
									All</a>
							</div>
						</div>
						<div class="overlay overlay-bg"></div>
			...
			<div class="row">
				<div class="col-xl-4 col-md-6 ">
					<div class="product-box-3 mb-lg-20">
						<div class="product-img">
							<a href="#"> <img src="https://via.placeholder.com/604x240"
						...
						<div class="product-caption">
							<div class="padding-tb-10">
								<h5 class="mb-1">
									<a href="#" class="text-light-black">foodmart® (Steak
										House)</a>
								</h5>
								<ul class="food-type">
								...
								<ul class="food-description">
									...
									<li class="text-light-black">4.2 <i
										class="fas fa-star text-yellow"></i> (200+)
									</li>
				...
				<div class="col-xl-4 col-md-6 ">
					<div class="product-box-3 mb-lg-20">
						...
						<div class="product-caption">
							<div class="padding-tb-10">
								<h5 class="mb-1">
									<a href="#" class="text-light-black">Mcvolant®
										(Vegiterian)</a>
								</h5>
								<ul class="food-type">
									<li class="text-light-white">$</li>
				...
				<div class="col-xl-4 col-md-6 ">
					<div class="product-box-3">
						...
						<div class="product-caption">
							<div class="padding-tb-10">
								<h5 class="mb-1">
									<a href="#" class="text-light-black">ckickchbox®
										(Specialty Chicken)</a>
								</h5>
								<ul class="food-type">
									<li class="text-light-white">$</li>
			...
			<div class="row">
				<div class="col-md-2 col-sm-4 col-6 mb-sm-20">
					<div class="icon-box">
						<span class="text-light-green"><i
							...
							class="text-custom-white">100% Payment<br>Secured
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6 mb-sm-20">
					<div class="icon-box">
						...
						<span class="text-custom-white">Support lots<br> of
							Payments
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6 mb-sm-20">
					<div class="icon-box">
						...
						<span class="text-custom-white">24 hours / 7 days<br>Support
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6">
					<div class="icon-box">
						...
						<span class="text-custom-white">Free Delivery<br>with
							$50
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6">
					<div class="icon-box">
						<span class="text-light-green"><i
							class="flaticon-guarantee"></i></span> <span class="text-custom-white">Best
							Price<br>Guaranteed
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6">
					<div class="icon-box">
						<span class="text-light-green"><i
							...
							class="text-custom-white">Mobile Apps<br>Ready
						</span>
					</div>
				</div>
			</div>
					...
					<div class="footer-contact">
						...
						<ul>
							<li class="fw-600"><span class="text-light-white">Call
									Us</span> <a href="tel:" class="text-custom-white">+(347) 123 456
									789</a></li>
							<li class="fw-600"><span class="text-light-white">Email
									Us</span> <a href="mailto:" class="text-custom-white">demo@domain.com</a>
							</li>
							<li class="fw-600"><span class="text-light-white">Join
									our twitter</span> <a href="#" class="text-custom-white">@foodmart</a>
							</li>
							<li class="fw-600"><span class="text-light-white">Join
									our instagram</span> <a href="#" class="text-custom-white">@foodmart</a>
							</li>
						</ul>
					</div>
				</div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-lg-4 text-center medewithlove align-self-center">
					<a href="http://www.Slidesigma.com" class="text-custom-white">Made
						with Real <i class="fas fa-heart"></i> Slidesigma
					</a>
				</div>
				<div class="col-lg-4">
					<div class="copyright-text">
						<span class="text-light-white">© <a href="#"
