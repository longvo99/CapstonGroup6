                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="homepage-4.html" class="text-light-white fw-500">Home Page 4</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    <li><a href="restaurant.html" class="text-light-white fw-500">restaurent</a>
                                                                    <li><a href="restaurant-style-1.html" class="text-light-white fw-500">restaurent 1</a>
                                                                    </li>
                                                                    <li><a href="restaurant-style-2.html" class="text-light-white fw-500">restaurent 2</a>
                                                                    </li>
                                                                    <li><a href="add-restaurant.html" class="text-light-white fw-500">Add restaurent</a>
                                                                    </li>
                    ...
                    <div class="col-lg-5">
                        <div class="content-wrapper bg-white padding-20">
                            <div class="content-box padding-tb-10 text-center">
                                <h3 class="text-light-black fw-700">Get started with foodmart today!</h3>
                                <form>
                                    <div class="row">
                                        <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-header-left">
                        <h3 class="text-light-black header-title title">Browse by cuisine <span class="fs-14"><a href="restaurant.html">See all restaurent</a></span></h3>
                    </div>
                </div>
                <div class="col-lg-2 col-sm-4 col-6">
                    <a href="#" class="categories mb-md-20">
                        <div class="icon text-custom-white bg-light-green ">
                            <img src="https://via.placeholder.com/160x160" class="img-fluid full-width" alt="categories">
                            <div class="overlay">
                    ...
                    <div class="blog-box">
                        ...
                        <article class="post">
                            <div class="blog-img p-relative">
                                <a href="#">
                                    <img src="https://via.placeholder.com/740x442" alt="blog-img">
                                </a>
                                <div class="overlay padding-20">
                                    <div class="blog-meta">
                                        <h4 class="text-custom-white mb-2 fw-600">New locations where you can now get your foodmart® delivered</h4>
                                        <a href="#" class="text-custom-white fw-700 fs-18">Read More</a>
                                    </div>
                                </div>
                                <div class="overlay overlay-bg"></div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="ad-img p-relative">
                        <img src="https://via.placeholder.com/1110x350" class="img-fluid full-width" alt="restaurant.html">
                        <div class="overlay">
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 ">
                    <div class="product-box-3 mb-lg-20">
                        <div class="product-img">
                            <a href="#">
                                <img src="https://via.placeholder.com/604x240" class="img-fluid full-width" alt="#">
                            </a>
                        </div>
                        <div class="product-caption">
                            <div class="padding-tb-10">
                                <h5 class="mb-1"><a href="#" class="text-light-black">foodmart® (Steak House)</a></h5>
                                <ul class="food-type">
                ...
                <div class="col-xl-4 col-md-6 ">
                    <div class="product-box-3 mb-lg-20">
                        ...
                        <div class="product-caption">
                            <div class="padding-tb-10">
                                <h5 class="mb-1"><a href="#" class="text-light-black">Mcvolant® (Vegiterian)</a></h5>
                                <ul class="food-type">
                                    <li class="text-light-white">$</li>
                                    <li class="text-light-white">American</li>
                                    <li class="text-light-white">Fast Food</li>
                ...
                <div class="col-xl-4 col-md-6 ">
                    <div class="product-box-3">
                        ...
                        <div class="product-caption">
                            <div class="padding-tb-10">
                                <h5 class="mb-1"><a href="#" class="text-light-black">ckickchbox® (Specialty Chicken)</a></h5>
                                <ul class="food-type">
                                    <li class="text-light-white">$</li>
                                    <li class="text-light-white">American</li>
                                    <li class="text-light-white">Fast Food</li>
                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="text-light-white fw-600">Find restaurent</a>
                            </li>
                ...
                <div class="col-xl col-lg-4 col-md-4 col-sm-6">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="text-light-white fw-600">Be a Partner restaurent</a>
                            </li>
