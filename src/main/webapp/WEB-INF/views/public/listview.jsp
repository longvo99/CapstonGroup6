                            ...
                            <div class="popular-item-slider swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="restaurant.html" class="categories">
                                            <div class="icon text-custom-white bg-light-green ">
                                                <img src="https://via.placeholder.com/125x125" class="rounded-circle" alt="categories">
                                    ...
                                    <div class="swiper-slide">
                                        <a href="restaurant.html" class="categories">
                                            <div class="icon text-custom-white bg-light-green ">
                                                <img src=" https://via.placeholder.com/125" class="rounded-circle" alt="categories">
                            ...
                            <div class="product-list-view">
                                <div class="product-list-info">
                                    <div class="product-list-img">
                                        <a href="restaurant.html">
                                            <img src="https://via.placeholder.com/90" class="img-fluid" alt="#">
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Lil Johnny</a></h6>
                            ...
                            <div class="product-list-view">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Big Bites</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
                            ...
                            <div class="product-list-view mb-xl-20">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">NewYork Bagels</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
                              ...
                              <i class="fas fa-star text-yellow"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product-box">
                                            ...
                                            <div class="product-caption">
                                                <div class="title-box">
                                                    <h6 class="product-title"><a href="restaurant.html" class="text-light-black">Smile Nâ Delight</a></h6>
                                                </div>
                              ...
                              <i class="fas fa-star text-yellow"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product-box">
                                            ...
                                            <div class="product-caption">
                                                <div class="title-box">
                                                    <h6 class="product-title"><a href="restaurant.html" class="text-light-black">Lil Johnny</a></h6>
                                                </div>
                            ...
                            <div class="product-list-view">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Sigma Bagels</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
                            ...
                            <div class="product-list-view">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Sunset Soup</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
                            ...
                            <div class="product-list-view">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Crispy Chicky</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
                            ...
                            <div class="product-list-view">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Small Bites</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
                            ...
                            <div class="product-list-view">
                                ...
                                <div class="product-right-col">
                                    <div class="product-list-details">
                                        <div class="product-list-title">
                                            <div class="product-info">
                                                <h6><a href="restaurant.html" class="text-light-black fw-600">Sunset Pizza</a></h6>
                                                <p class="text-light-white fs-12">American Bagels</p>
                                            </div>
                                        </div>
                                        <div class="product-detail-right-box">
