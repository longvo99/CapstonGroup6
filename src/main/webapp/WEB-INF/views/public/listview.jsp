			...
			<aside class="col-lg-3 mb-md-40">
				<div class="filter-sidebar mb-5">
					<h4 class="text-light-black fw-600 title-2">
						Filters<small class="fs-12"><a href="#"
							class="text-light-black fw-500">Clear all</a></small>
					</h4>
					<div class="sidebar-tab">
						<ul class="nav nav-pills mb-xl-20">
							<li class="nav-item"><a class="nav-link active"
								data-toggle="pill" href="#restaurents">Restaurants</a></li>
							<li class="nav-item"><a class="nav-link" data-toggle="pill"
								href="#caterings">Caterings</a></li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane fade show active" id="restaurents">
								<div class="siderbar-innertab">
									<ul class="nav nav-pills">
										<li class="nav-item"><a class="nav-link active"
											data-toggle="pill" href="#delivery-restaurents">Delivery</a>
										</li>
										<li class="nav-item"><a class="nav-link"
											data-toggle="pill" href="#pickup-restaurents">Pickup</a></li>
									</ul>
								</div>
								<div class="tab-content" id="pills-tabContent">
									<div class="tab-pane fade show active"
										id="delivery-restaurents">
										<p class="text-light-black delivery-type p-relative">
											Delivery my food <a href="#">Today, ASAP</a>
										</p>
										<div class="filters">
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
													...
													<div class="card-body">
														<form>
															<label class="custom-checkbox"> <input
																...
																class="checkmark"></span> New <span
																class="text-light-white">(3)</span>
															</label> <label class="custom-checkbox"> <input
																type="checkbox" name="#"> <span
																class="checkmark"></span> Order Tracking <span
																class="text-light-white">(6)</span>
															</label> <label class="custom-checkbox"> <input
																type="checkbox" name="#"> <span
																class="checkmark"></span> Open Now [6:05am] <span
																class="text-light-white">(10)</span>
															</label> <label class="custom-checkbox"> <input
																type="checkbox" name="#"> <span
																class="checkmark"></span> Free Delivery <span
																class="text-light-white">(6)</span>
															</label>
														</form>
													</div>
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#deliverycollapseTwo">
														Rating </a>
												</div>
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#deliverycollapseThree">
														Price </a>
												</div>
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#deliverycollapseFour">
														Delivery time </a>
												</div>
									...
									<div class="tab-pane fade" id="pickup-restaurents">
										<p class="text-light-black delivery-type p-relative">
											Pick my food <a href="#">Today, ASAP</a>
										</p>
										<div class="filters">
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#pickupcollapseOne">
														Feature </a>
												</div>
												<div id="pickupcollapseOne" class="collapse show">
													<div class="card-body">
														<form>
															<label class="custom-checkbox"> <input
																type="checkbox" name="#"> <span
																class="checkmark"></span> Coupons <span
																class="text-light-white">(1)</span>
															</label> <label class="custom-checkbox"> <input
																type="checkbox" name="#"> <span
																class="checkmark"></span> New <span
																class="text-light-white">(26)</span>
															</label> <label class="custom-checkbox"> <input
																type="checkbox" name="#"> <span
																class="checkmark"></span> Open Now [7:08am] <span
																class="text-light-white">(236)</span>
															</label>
														</form>
													</div>
												</div>
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#pickupcollapseTwo">
														Rating </a>
												</div>
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#pickupcollapseThree">
														Price </a>
												</div>
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse" href="#pickupcollapseFour">
														Distance </a>
												</div>
							...
							<div class="tab-pane fade" id="caterings">
								<div class="siderbar-innertab">
									<ul class="nav nav-pills">
										<li class="nav-item"><a class="nav-link active"
											data-toggle="pill" href="#delivery-caterings">Delivery</a></li>
										<li class="nav-item"><a class="nav-link disabled"
											data-toggle="pill" href="#pickup-caterings">Pickup</a></li>
									</ul>
								</div>
								<div class="tab-content">
										...
										<div class="filters">
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														...
														href="#delivery-cateringscollapseOne"> Feature </a>
												</div>
												<div id="delivery-cateringscollapseOne"
													class="collapse show">
													<div class="card-body">
														<form>
															<label class="custom-checkbox"> <input
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse"
														href="#delivery-cateringscollapseTwo"> Rating </a>
												</div>
												<div id="delivery-cateringscollapseTwo"
													class="collapse show">
													<div class="card-body">
														<div class="rating">
															<button class="text-yellow">
											...
											<div class="card">
												<div class="card-header">
													<a class="card-link text-light-black fw-700 fs-16"
														data-toggle="collapse"
														href="#delivery-cateringscollapseThree"> Price </a>
												</div>
												<div id="delivery-cateringscollapseThree"
													class="collapse show">
													<div class="card-body">
														<div class="rating">
															<button class="text-success">$</button>
				...
				<div
					class="advertisement-slider swiper-container p-relative h-auto mb-md-40">
									...
									<div class="testimonial-img p-relative">
										...
										<div class="overlay">
											...
											<div class="add-fav text-success">
												<img
													src="${pageContext.request.contextPath}/resources/public/assets/img/svg/013-heart-1.svg"
													alt="tag">
											</div>
										</div>
									</div>
					...
					<div class="col-12">
						<div class="section-header-left">
							<h3 class="text-light-black header-title title-2">
								Most popular near you <small><a href="#"
									class="text-dark-white fw-600">29 restaurant</a></small>
							</h3>
						</div>
					</div>
					<div class="col-12">
									...
									<a href="restaurant.html" class="categories">
										<div class="icon text-custom-white bg-light-green ">
											<img src=" https://via.placeholder.com/125"
												class="rounded-circle" alt="categories">
										</div> <span class="text-light-black cat-name">Smile Delight</span>
									</a>
								</div>
								<div class="swiper-slide">
									<a href="restaurant.html" class="categories">
										<div class="icon text-custom-white bg-light-green ">
											<img src=" https://via.placeholder.com/125"
												class="rounded-circle" alt="categories">
										</div> <span class="text-light-black cat-name">Lil Johnny</span>
									</a>
								</div>
								<div class="swiper-slide">
									<a href="restaurant.html" class="categories">
						...
						<div class="sort-tag-filter padding-15">
							<div class="restaurent-tags">
								<span class="tags">open now <span class="close">x</span></span>
								<span class="tags">new <span class="close">x</span></span>
							</div>
							<div class="sorting">
								<span class="text-dark-white fs-16 fw-600">Sort: </span> <select>
						...
						<div class="product-list-view">
							<div class="product-list-info">
								<div class="product-list-img">
									<a href="restaurant.html"> <img
										src="https://via.placeholder.com/90" class="img-fluid" alt="#">
									</a>
								</div>
							</div>
								...
								<div class="product-list-details">
									<div class="product-list-title">
										<div class="product-info">
											<h6>
												<a href="restaurant.html" class="text-light-black fw-600">Lil
													Johnny</a>
											</h6>
									...
									<div class="product-detail-right-box">
										...
										<div class="product-list-tags">
											<span class="text-custom-white rectangle-tag bg-gradient-red">
												10% </span> <span
												class="rectangle-tag bg-gradient-green text-custom-white">
												Trending </span>
										</div>
						...
						<div class="product-list-view">
							<div class="product-list-info">
								<div class="product-list-img">
									<a href="restaurant.html"> <img
										src=" https://via.placeholder.com/90" class="img-fluid"
										alt="#">
									</a>
								</div>
							</div>
							...
							<div class="product-right-col">
								<div class="product-list-details">
									<div class="product-list-title">
										<div class="product-info">
											<h6>
												<a href="restaurant.html" class="text-light-black fw-600">NewYork
													Bagels</a>
											</h6>
											<p class="text-light-white fs-12">American Bagels</p>
										</div>
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="product-box">
											...
											<div class="product-details">
												...
												<div class="rating">
													<span> <i class="fas fa-star text-yellow"></i> <i
														...
														class="fas fa-star text-yellow"></i> <i
														class="fas fa-star text-yellow"></i>
													</span> <span class="text-light-white text-right">5689
														ratings</span>
												</div>
											</div>
										</div>
										<div class="product-footer-2">
											<div class="discount">
												<span class="text-success fs-12">$5 off</span>
											</div>
											<div class="discount-coupon">
												<span class="text-light-white fs-12">First order only</span>
											</div>
											...
											<div class="product-details">
												...
												<div class="rating">
													<span> <i class="fas fa-star text-yellow"></i> <i
														...
														class="fas fa-star text-yellow"></i> <i
														class="fas fa-star text-yellow"></i>
													</span> <span class="text-light-white text-right">8225
														ratings</span>
												</div>
											</div>
										</div>
											...
											<div class="product-details">
												...
												<div class="rating">
													<span> <i class="fas fa-star text-yellow"></i> <i
														...
														class="fas fa-star text-yellow"></i> <i
														class="fas fa-star text-yellow"></i>
													</span> <span class="text-light-white text-right">425
														ratings</span>
												</div>
											</div>
										</div>
							...
							<div class="product-right-col">
								<div class="product-list-details">
									<div class="product-list-title">
										<div class="product-info">
											<h6>
												<a href="restaurant.html" class="text-light-black fw-600">Sigma
													Bagels</a>
											</h6>
											<p class="text-light-white fs-12">American Bagels</p>
										</div>
							...
							<div class="product-right-col">
								<div class="product-list-details">
									<div class="product-list-title">
										<div class="product-info">
											<h6>
												<a href="restaurant.html" class="text-light-black fw-600">Sunset
													Soup</a>
											</h6>
											<p class="text-light-white fs-12">American Bagels</p>
										</div>
							...
							<div class="product-right-col">
								<div class="product-list-details">
									<div class="product-list-title">
										<div class="product-info">
											<h6>
												<a href="restaurant.html" class="text-light-black fw-600">Crispy
													Chicky</a>
											</h6>
											<p class="text-light-white fs-12">American Bagels</p>
										</div>
							...
							<div class="product-right-col">
								<div class="product-list-details">
									<div class="product-list-title">
										<div class="product-info">
											<h6>
												<a href="restaurant.html" class="text-light-black fw-600">Small
													Bites</a>
											</h6>
											<p class="text-light-white fs-12">American Bagels</p>
										</div>
