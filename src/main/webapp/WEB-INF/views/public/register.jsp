                    ...
                    <div class="col-lg-6 col-md-12 col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="#" class="form-control form-control-submit" placeholder="Last Name" required>
									...
									<div class="col-12">
										<div class="form-group">
											<label class="text-light-white fs-14">Username</label> <input
												type="text" name="#"
												class="form-control form-control-submit" required>
										</div>
										<div class="form-group">
											<label class="text-light-white fs-14">Password (8
												character minimum)</label> <input type="password"
										...
										<div class="form-group">
											<label class="text-light-white fs-14">Fullname</label> <input
												type="text" name="#"
												class="form-control form-control-submit" required>
										</div>
										<div class="form-group">
											<label class="text-light-white fs-14">Phone number</label> <input
												type="tel" pattern="[0-9]{10}" name="#"
												class="form-control form-control-submit" required>
										</div>
										<div class="form-group">
											<label class="text-light-white fs-14">Address</label> <input
												type="text" name="#"
												class="form-control form-control-submit" required>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label class="text-light-white fs-14">Gender</label> <input
										...
										<div class="form-group">
											<label class="text-light-white fs-14">Birthday</label> <input
										...
										<div class="form-group">
											<button type="submit"
												class="btn-second btn-submit full-width">Create
												your account</button>
										</div>
										...
										<div class="form-group">
											<button type="submit"
												...
												<img
													src="${pageContext.request.contextPath}/resources/public/assets/img/facebook-logo.svg"
													alt="btn logo">Continue with Facebook
											</button>
										</div>
										<div class="form-group">
											<button type="submit"
												...
												<img
													src="${pageContext.request.contextPath}/resources/public/assets/img/google-logo.png"
													alt="btn logo">Continue with Google
											</button>
										</div>
										<div class="form-group text-center">
										...
										<span class="text-light-black fs-12 terms">By creating
											your foodmart account, you agree to the <a href="#">
												Terms of Use </a> and <a href="#"> Privacy Policy.</a>
										</span>
									</div>
								</div>
							</form>
