...
<body>
                                                        ...
                                                        <div class="col-lg-3 col-sm-6">
                                                            <div class="menu-style">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li class="active"><a href="restaurant-style-2.html" class="text-light-white fw-500">Restaurant 2</a>
                                                                    </li>
    ...
    <div class="page-banner p-relative smoothscroll" id="menu">
        <img src="https://via.placeholder.com/1339x270" class="img-fluid full-width" alt="banner">
        <div class="overlay-2">
            <div class="container">
                <div class="row">
                    <div class="col-6">
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="text-center"> <span class="text-light-black fs-12">*Valid on first order only, for one-time use, subject to foodmart’s verification. Additional terms may apply. By signing up, you agree to receive marketing and promotional emails and communications form foodmart</span>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="promocodeimg mb-xl-20 p-relative">
                                <img src="https://via.placeholder.com/640x115" class="img-fluid full-width" alt="promocode">
                                <div class="promocode-text">
                                    ...
                                    <div class="promocode-btn"> <a href="ex-deals.html">Get Deal</a>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">4645 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">2005 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">3658 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">586 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">7485 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">1028 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">2888 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">7458 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">6599 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                                                        ...
                                                        <div class="restaurent-product-left">
                                                            <div class="restaurent-product-title-box">
                                                                ...
                                                                <div class="restaurent-product-rating">
                                                                    ...
                                                                    <div class="rating-text">
                                                                        <p class="text-light-white fs-12 title">1125 ratings</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="restaurent-product-caption-box"> <span class="text-light-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor...</span>
                          ...
                          $2.25
                                    ...
                                    <div class="cat-product-box">
                                        <div class="cat-product">
                                            <div class="cat-name">
                                                <a href="#">
                                                    <p class="text-light-green fw-700"><span class="text-dark-white">1</span> Cheesy Backed Tao</p> <span class="text-light-white fw-700">small, chilli chicken</span>
                                                </a>
                                            </div>
                                            <div class="delete-btn">
                                                <a href="#" class="text-dark-white"> <i class="far fa-trash-alt"></i>
                          ...
                          $2.25
                                    ...
                                    <div class="cat-product-box">
                                        <div class="cat-product">
                                            <div class="cat-name">
                                                <a href="#">
                                                    <p class="text-light-green fw-700"><span class="text-dark-white">1</span> Crispy Chicken Piza</p> <span class="text-light-white fw-700">small, chilli chicken</span>
                                                </a>
                                            </div>
                                            <div class="delete-btn">
                                                <a href="#" class="text-dark-white"> <i class="far fa-trash-alt"></i>
