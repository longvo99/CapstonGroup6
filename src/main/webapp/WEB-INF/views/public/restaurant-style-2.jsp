...
<body>
					...
					<div class="col-12 mainNavCol">
						...
						<div class="logo mainNavCol">
							<a href="index.html"> <img
								src="https://via.placeholder.com/106x30" class="img-fluid"
								alt="Logo">
							</a>
						</div>
						<!-- logo -->
							...
							<form class="main-search search-form full-width">
								<div class="row">
									...
									<div class="col-lg-6 col-md-5">
										<a href="#" class="delivery-add p-relative"> <span
											class="icon"><i class="fas fa-map-marker-alt"></i></span> <span
						...
						<div class="right-side fw-700 mainNavCol">
							<div class="gem-points">
								<a href="#"> <i class="fas fa-concierge-bell"></i> <span>Order
										Now</span>
								</a>
							</div>
														...
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																<div class="menu-title">
																	<h6 class="cat-name">
																		<a href="#" class="text-light-black">Home Pages</a>
																	</h6>
																</div>
																<ul>
																	<li><a href="index.html"
																		class="text-light-white fw-500">Landing Page</a></li>
																	<li><a href="homepage-1.html"
																		class="text-light-white fw-500">Home Page 1</a></li>
																	<li><a href="homepage-2.html"
																		class="text-light-white fw-500">Home Page 2</a></li>
																	<li><a href="homepage-3.html"
																		class="text-light-white fw-500">Home Page 3</a></li>
																	<li><a href="homepage-4.html"
																		class="text-light-white fw-500">Home Page 4</a></li>
																</ul>
															</div>
														</div>
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																<div class="menu-title">
																	<h6 class="cat-name">
																		<a href="#" class="text-light-black">Inner Pages</a>
																	</h6>
																</div>
																<ul>
																	<li><a href="blog.html"
																		class="text-light-white fw-500">Blog Grid View</a></li>
																	<li><a href="blog-style-2.html"
																		class="text-light-white fw-500">Blog Grid View 2</a></li>
																	<li><a href="blog-details.html"
																		class="text-light-white fw-500">Blog Details</a></li>
																	<li><a href="ex-deals.html"
																		class="text-light-white fw-500">Ex Deals</a></li>
																	<li><a href="about.html"
																		class="text-light-white fw-500">About Us</a></li>
																</ul>
															</div>
														</div>
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																<div class="menu-title">
																	<h6 class="cat-name">
																		<a href="#" class="text-light-black">Related Pages</a>
																	</h6>
																</div>
																<ul>
																	<li><a href="restaurant.html"
																		class="text-light-white fw-500">Restaurant</a></li>
																	<li><a href="restaurant-style-1.html"
																		class="text-light-white fw-500">Restaurant 1</a></li>
																	<li class="active"><a
																		href="restaurant-style-2.html"
																		class="text-light-white fw-500">Restaurant 2</a></li>
																	<li><a href="add-restaurant.html"
																		class="text-light-white fw-500">Add Restaurant</a></li>
																	<li><a href="list-view.html"
																		class="text-light-white fw-500">List View</a></li>
																</ul>
															</div>
														</div>
														<div class="col-lg-3 col-sm-6">
															<div class="menu-style">
																<div class="menu-title">
																	<h6 class="cat-name">
																		<a href="#" class="text-light-black">Additional
																			Pages</a>
																	</h6>
																</div>
																<ul>
																	<li><a href="login.html"
																		class="text-light-white fw-500">Login</a></li>
																	<li><a href="register.html"
																		class="text-light-white fw-500">Sign-up</a></li>
																	<li><a href="checkout.html"
																		class="text-light-white fw-500">Checkout</a></li>
																	<li><a href="order-details.html"
																		class="text-light-white fw-500">Order Details</a></li>
																	<li><a href="geo-locator.html"
																		class="text-light-white fw-500">Geo Locator</a></li>
																</ul>
															</div>
														</div>
													</div>
							...
							<div class="user-details p-relative">
								<a href="#" class="text-light-white fw-500"> <img
									src="https://via.placeholder.com/30" class="rounded-circle"
									alt="userimg"> <span>Hi, Kate</span>
								</a>
								<div class="user-dropdown">
									...
									<div class="user-footer">
										<span class="text-light-black">Not Jhon?</span> <a href="#">Sign
											Out</a>
									</div>
								</div>
							</div>
							...
							<div class="cart-btn notification-btn">
								<a href="#" class="text-light-green fw-700"> <i
									class="fas fa-bell"></i> <span class="user-alert-notification"></span>
								</a>
	...
	<div class="page-banner p-relative smoothscroll" id="menu">
		<img src="https://via.placeholder.com/1339x270"
			...
			<div class="row">
				<div class="col-md-12">
					<div class="heading padding-tb-10">
						<h3 class="text-light-black title fw-700 no-margin">Great
							Burger</h3>
						<p class="text-light-black sub-title no-margin">
							4508 Fort Hamilton Pkwy <span><a href="checkout.html"
						...
						<div class="head-rating">
							<div class="rating">
								<span class="fs-16 text-yellow"> <i class="fas fa-star"></i>
									...
									class="fas fa-star"></i>
								</span> <span class="text-light-black fs-12 rate-data">58 rating</span>
							</div>
							<div class="product-review">
								...
								<h6 class="text-light-black no-margin">
									91<span class="fs-14">% Food was good</span>
								</h6>
								<h6 class="text-light-black no-margin">
									91<span class="fs-14">% Food was good</span>
								</h6>
					...
					<div class="restaurent-logo">
						<img src="https://via.placeholder.com/80" class="img-fluid"
							alt="#">
					</div>
				</div>
			</div>
	...
	<div id="accordion">
					...
					<div class="col-12">
						<div class="restaurent-menu">
							<ul class="nav nav-pills">
								...
								<li class="nav-item"><a
									class="nav-link text-light-white fw-700" data-toggle="collapse"
									data-target="#aboutcollapse" href="javascript:void(0)">About</a>
								</li>
								<li class="nav-item"><a
									class="nav-link text-light-white fw-700" data-toggle="collapse"
									data-target="#reviewcollapse" href="javascript:void(0)">Reviews</a>
								</li>
								<li class="nav-item"><a
									class="nav-link text-light-white fw-700" data-toggle="collapse"
									data-target="#mapgallerycollapse" href="javascript:void(0)">Map
										& Gallery</a></li>
							</ul>
		...
		<!-- restaurent tab -->
		<!-- restaurent about -->
		<section class="section-padding restaurent-about collapse"
			id="aboutcollapse" data-parent="#accordion">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h3 class="text-light-black fw-700 title">Great Burger</h3>
						<p class="text-light-green no-margin">American, Breakfast,
							Coffee and Tea, Fast Food, Hamburgers</p>
						<p class="text-light-white no-margin">Lorem ipsum dolor sit
						...
						<ul class="about-restaurent">
							<li><i class="fas fa-map-marker-alt"></i> <span> <a
									href="#" class="text-light-white"> 314 79th St<br>
										Rite Aid, Brooklyn, NY, 11209
								</a>
							</span></li>
							<li><i class="fas fa-phone-alt"></i> <span><a
									href="tel:" class="text-light-white">(347) 123456789</a></span></li>
							<li><i class="far fa-envelope"></i> <span><a
									href="mailto:" class="text-light-white">demo@domain.com</a></span></li>
						</ul>
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="schedule-box">
										...
										<div class="time text-light-black">Delivery: 7:00am -
											10:59pm</div>
									</div>
								...
								<div class="card-footer">
									<a class="fw-500 collapsed" data-toggle="collapse"
										href="#schdule">See the full schedule</a>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- restaurent about -->
		<!-- map gallery -->
		<div class="map-gallery-sec section-padding bg-light-theme collapse"
			id="mapgallerycollapse" data-parent="#accordion">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="main-box">
		...
		<!-- map gallery -->
		<!-- restaurent reviews -->
		<section class="section-padding restaurent-review collapse"
			id="reviewcollapse" data-parent="#accordion">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="section-header-left">
							<h3 class="text-light-black header-title title">Reviews for
								Great Burger</h3>
						</div>
						<div class="restaurent-rating mb-xl-20">
							...
							<span class="fs-12 text-light-black">58 Ratings</span>
						</div>
						<p class="text-light-black mb-xl-20">Here's what people are
							saying:</p>
						<ul>
							<li>
								<h6 class="text-light-black mb-1">73%</h6> <span
								class="text-light-black fs-12 fw-400">Food was good</span>
							</li>
							<li>
								<h6 class="text-light-black mb-1">85%</h6> <span
								class="text-light-black fs-12 fw-400">Delivery was on
									time</span>
							</li>
							<li>
								<h6 class="text-light-black mb-1">68%</h6> <span
								class="text-light-black fs-12 fw-400">Order was accurate</span>
							</li>
						</ul>
						...
						<div class="review-box">
							<div class="review-user">
								<div class="review-user-img">
									...
									<div class="reviewer-name">
										<p class="text-light-black fw-600">
											Sarra <small class="text-light-white fw-500">New
												York, (NY)</small>
										</p>
								...
								<div class="review-date">
									<span class="text-light-white">Sep 20, 2020</span>
								</div>
							</div>
							<div class="ratings">
								<span class="text-yellow fs-16"> <i class="fas fa-star"></i>
								...
								</span> <span class="ml-2 text-light-white">2 days ago </span>
							</div>
							<p class="text-light-black">Delivery was fast and friendly.
								Food was not great especially the salad. Will not be ordering
								from again. Too many options to settle for this place.</p>
					...
					<div class="col-12">
						<div class="review-img">
							...
							<div class="review-text">
								<h2 class="text-light-white mb-2 fw-600">Be one of the
									first to review</h2>
								<p class="text-light-white">Order now and write a review to
									give others the inside scoop.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="address-details">
						<div class="address">
							<div class="delivery-address">
								<a href="order-details.html" class="text-light-black">Delivery,
									ASAP (45–55m)</a>
								<div class="delivery-type">
									<span class="text-success fs-12 fw-500">No minimun</span><span
										class="text-light-white">, Free Delivery</span>
								</div>
							</div>
							<div class="change-address">
								<a href="checkout.html" class="fw-500">Change</a>
							</div>
						</div>
						<p class="text-light-white no-margin">Lorem ipsum dolor sit
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xl-3 col-lg-3">
					<div class="sidebar2">
						<div
							class="advertisement-slider swiper-container h-auto mb-xl-20 mb-md-40">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<div class="testimonial-wrapper">
										<div class="testimonial-box">
											<div class="testimonial-img p-relative">
												<a href="restaurant.html"> <img
													src="https://via.placeholder.com/438x180"
											...
											<div class="testimonial-caption padding-15">
												...
												<h5 class="fw-600">
													<a href="restaurant.html" class="text-light-black">GSA
														King Tomato Farm</a>
												</h5>
												...
												<div class="ratings">
													<span class="text-yellow fs-16"> <i
														class="fas fa-star"></i>
													</span> <span class="text-yellow fs-16"> <i
														class="fas fa-star"></i>
													</span> <span class="text-yellow fs-16"> <i
														class="fas fa-star"></i>
													</span> <span class="text-yellow fs-16"> <i
												...
												<p class="text-light-black">Delivery was fast and
													friendly...</p>
												<p class="text-light-white fw-100">
													<strong class="text-light-black fw-700">Local
														delivery: </strong> From $7.99 (4.0 mi)
												</p>
												<a href="checkout.html" class="btn-second btn-submit">Order
													Now</a>
											</div>
										</div>
									</div>
						...
						<div class="card sidebar-card">
							<div class="card-header no-padding">
								<div class="offer-content">
									<h2 class="text-custom-white fw-700">
										Get $12 off <small class=" fw-700">your order*</small>
									</h2>
									<p class="text-custom-white">
										As an added treat, enjoy <strong>free delivery</strong> from <br>select
										restaurants automatically applied at checkout
									</p>
								</div>
							</div>
								...
								<form>
									<div class="row">
										<div class="col-12">
											...
											<div class="form-group">
												<label class="text-light-white fs-14">ZIP Code</label> <input
													type="number" name="#"
													class="form-control form-control-submit"
													placeholder="10421">
											</div>
											<div class="form-group">
												<button type="submit"
													class="btn-second btn-submit full-width">Save $12
													on your first order</button>
											</div>

											<div class="text-center">
												<span class="text-light-black fs-12">*Valid on first
													order only, for one-time use, subject to foodmart’s
													verification. Additional terms may apply. By signing up,
													you agree to receive marketing and promotional emails and
													communications form foodmart</span>
											</div>
										</div>
									</div>
								</form>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="promocodeimg mb-xl-20 p-relative">
								<img src="https://via.placeholder.com/640x115"
									class="img-fluid full-width" alt="promocode">
								<div class="promocode-text">
									<div class="promocode-text-content">
										<h5 class="text-custom-white mb-2 fw-600">Get $10 off
											your first order!</h5>
										<p class="text-custom-white no-margin">Spend $15 or more
											and get $10 off your first delivery order.</p>
									</div>
									<div class="promocode-btn">
										<a href="ex-deals.html">Get Deal</a>
									</div>
								</div>
									...
									<div class="section-header-left">
										<h3 class="text-light-black header-title">
											<a class="card-link text-light-black no-margin"
												data-toggle="collapse" href="#collapseOne"> Most Popular
											</a>
										</h3>
									</div>
								</div>
												...
												<div class="restaurent-product-list">
													<div class="restaurent-product-detail">
															...
															<div class="restaurent-product-title-box">
																	...
																	<div class="restaurent-product-title">
																		<h6 class="mb-2" data-toggle="modal"
																			...
																			<a href="javascript:void(0)"
																				class="text-light-black fw-600">Bacon Egg &
																				Vegan Burger - Meal</a>
																		</h6>
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">4645
																			ratings</p>
																	</div>
																</div>
															</div>
															<div class="restaurent-product-caption-box">
																<span class="text-light-white">Lorem ipsum dolor
															...
															<div class="restaurent-tags-price">
																<div class="restaurent-tags">
																	<span class="text-custom-white square-tag"> <img
																		src="assets/img/svg/004-leaf.svg" alt="tag">
																	</span> <span class="text-custom-white square-tag"> <img
																		src="assets/img/svg/006-chili.svg" alt="tag">
																	</span> <span class="text-custom-white square-tag"> <img
																		src="assets/img/svg/005-chef.svg" alt="tag">
																	</span> <span class="text-custom-white square-tag"> <img
																		src="assets/img/svg/008-protein.svg" alt="tag">
																	</span> <span class="text-custom-white square-tag"> <img
																		src="assets/img/svg/009-lemon.svg" alt="tag">
																	</span>
																</div>
																<span class="circle-tag"> <img
																	src="assets/img/svg/010-heart.svg" alt="tag">
																</span>
														...
														<div class="restaurent-product-img">
															<img src="https://via.placeholder.com/150x151"
																class="img-fluid" alt="#">
														</div>
													</div>
												</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">2005
																			ratings</p>
																	</div>
																</div>
															</div>
															...
															<div class="restaurent-tags-price">
																...
																<span class="circle-tag"> <img
																	src="assets/img/svg/013-heart-1.svg" alt="tag">
																</span>
																<div class="restaurent-product-price">
																	<h6 class="text-success fw-600 no-margin">$7.99+</h6>
																</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">3658
																			ratings</p>
																	</div>
																</div>
															</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">586
																			ratings</p>
																	</div>
																</div>
															</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">7485
																			ratings</p>
																	</div>
																</div>
															</div>
							...
							<div class="card">
								<div class="card-header">
									<div class="section-header-left">
										<h3 class="text-light-black header-title">
											<a class="card-link text-light-black no-margin"
												data-toggle="collapse" href="#collapseTwo"> Combo Meals
											</a>
										</h3>
									</div>
								</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																<div class="restaurent-product-box">
																	<div class="restaurent-product-title">
																		<h6 class="mb-2" data-toggle="modal"
																			data-target="#restaurent-popup">
																			<a href="javascript:void(0)"
																				class="text-light-black fw-600">Hakka Noodles &
																				Sticky Date Cake - Meal</a>
																		</h6>
																		<p class="text-light-white">600-700 Cal.</p>
																	</div>
																	<div class="restaurent-product-label">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">1028
																			ratings</p>
																	</div>
																</div>
															</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">2888
																			ratings</p>
																	</div>
																</div>
															</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">7458
																			ratings</p>
																	</div>
																</div>
															</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">6599
																			ratings</p>
																	</div>
																</div>
															</div>
														...
														<div class="restaurent-product-left">
															<div class="restaurent-product-title-box">
																...
																<div class="restaurent-product-rating">
																	...
																	<div class="rating-text">
																		<p class="text-light-white fs-12 title">1125
																			ratings</p>
																	</div>
																</div>
															</div>
						...
						<div class="video-box mb-xl-20">
							...
							<div class="discount-box main-box padding-tb-10">
								<div class="discount-price padding-10">
									<div class="left-side">
										<h6 class="text-light-black fw-600 no-margin">Watch Now
											and get 50% discount</h6>
										<p class="text-light-white no-margin">The hung-over foody
											(2020)</p>
									</div>
									<div class="right-side justify-content-end">
										...
										<a href="restaurent.html"> <img
											src="https://via.placeholder.com/94x54" class="img-fluid"
											alt="logo">
										</a>
									</div>
								</div>
						...
						<div class="cart-detail-box">
							<div class="card">
								...
								<div class="card-body no-padding" id="scrollstyle-4">
											...
											<div class="cat-name">
												<a href="#">
													<p class="text-light-green fw-700">
														<span class="text-dark-white">1</span> Chilli Chicken
														Pizza
													</p> <span class="text-light-white fw-700">small, chilli
														chicken</span>
												</a>
											</div>
											<div class="delete-btn">
									...
									<div class="cat-product-box">
										<div class="cat-product">
											<div class="cat-name">
												<a href="#">
													<p class="text-light-green fw-700">
														<span class="text-dark-white">1</span> Cheesy Backed Tao
													</p> <span class="text-light-white fw-700">small, chilli
														chicken</span>
												</a>
											</div>
									...
									<div class="cat-product-box">
										<div class="cat-product">
											<div class="cat-name">
												<a href="#">
													<p class="text-light-green fw-700">
														<span class="text-dark-white">1</span> Crispy Chicken Piza
													</p> <span class="text-light-white fw-700">small, chilli
														chicken</span>
												</a>
											</div>
									...
									<div class="item-total">
										<div class="total-price border-0">
											<span class="text-dark-white fw-700">Items subtotal:</span> <span
												class="text-dark-white fw-700">$8.50</span>
										</div>
	...
	<section class="fresh-deals section-padding">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-header-left">
						<h3 class="text-light-black header-title title">Offers near
							you</h3>
					</div>
				</div>
				<div class="col-12">
									...
									<div class="product-caption">
										<div class="title-box">
											<h6 class="product-title">
												<a href="restaurant.html" class="text-light-black">Great
													Burger</a>
											</h6>
										</div>
										...
										<div class="product-details">
											<div class="price-time">
												<span class="text-light-black time">30-40 min</span> <span
													class="text-light-white price">$10 min</span>
											</div>
											<div class="rating">
												...
												</span> <span class="text-light-white text-right">4225
													ratings</span>
											</div>
										</div>
									</div>
							...
							<div class="swiper-slide">
								<div class="product-box">
									...
									<div class="product-caption">
										<div class="title-box">
											<h6 class="product-title">
												<a href="restaurant.html" class="text-light-black">Flavor
													Town</a>
											</h6>
										</div>
							...
							<div class="swiper-slide">
								<div class="product-box">
									...
									<div class="product-caption">
										<div class="title-box">
											<h6 class="product-title">
												<a href="restaurant.html" class="text-light-black">Big
													Bites</a>
											</h6>
										</div>
							...
							<div class="swiper-slide">
								<div class="product-box">
									...
									<div class="product-caption">
										<div class="title-box">
											<h6 class="product-title">
												<a href="restaurant.html" class="text-light-black">Smile
													N’ Delight</a>
											</h6>
										</div>
							...
							<div class="swiper-slide">
								<div class="product-box">
									...
									<div class="product-caption">
										<div class="title-box">
											<h6 class="product-title">
												<a href="restaurant.html" class="text-light-black">Lil
													Johnny’s</a>
											</h6>
										</div>
			...
			<div class="row">
				<div class="col-md-2 col-sm-4 col-6 mb-sm-20">
					<div class="icon-box">
						<span class="text-light-green"><i
							...
							class="text-light-black">100% Payment<br>Secured
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6 mb-sm-20">
					<div class="icon-box">
						...
						<span class="text-light-black">Support lots<br> of
							Payments
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6 mb-sm-20">
					<div class="icon-box">
						...
						<span class="text-light-black">24 hours / 7 days<br>Support
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6">
					<div class="icon-box">
						...
						<span class="text-light-black">Free Delivery<br>with
							$50
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6">
					<div class="icon-box">
						<span class="text-light-green"><i
							class="flaticon-guarantee"></i></span> <span class="text-light-black">Best
							Price<br>Guaranteed
						</span>
					</div>
				</div>
				<div class="col-md-2 col-sm-4 col-6">
					<div class="icon-box">
						<span class="text-light-green"><i
							...
							class="text-light-black">Mobile Apps<br>Ready
						</span>
					</div>
				</div>
			</div>
		...
		<div class="u-line instagram-slider swiper-container">
			<ul class="hm-list hm-instagram swiper-wrapper">
				<li class="swiper-slide"><a href="#"><img
						src="https://via.placeholder.com/250x200" alt="instagram"></a></li>
				<li class="swiper-slide"><a href="#"><img
						src="https://via.placeholder.com/250x200" alt="instagram"></a></li>
				<li class="swiper-slide"><a href="#"><img
						src="https://via.placeholder.com/250x200" alt="instagram"></a></li>
			...
			<div class="row">
				<div class="col-xl col-lg-4 col-md-4 col-sm-6">
					<div class="footer-contact">
						...
						<ul>
							<li class="fw-600"><span class="text-light-white">Call
									Us</span> <a href="tel:" class="text-light-black">+(347) 123 456
									789</a></li>
							<li class="fw-600"><span class="text-light-white">Email
									Us</span> <a href="mailto:" class="text-light-black">demo@domain.com</a>
							</li>
							<li class="fw-600"><span class="text-light-white">Join
									our twitter</span> <a href="#" class="text-light-black">@foodmart</a>
							</li>
							<li class="fw-600"><span class="text-light-white">Join
									our instagram</span> <a href="#" class="text-light-black">@foodmart</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-xl col-lg-4 col-md-4 col-sm-6">
					<div class="footer-links">
						...
						<ul>
							<li><a href="#" class="text-light-white fw-600">Account
									Details</a></li>
							<li><a href="#" class="text-light-white fw-600">Order
									History</a></li>
							<li><a href="#" class="text-light-white fw-600">Find
									restaurant</a></li>
							<li><a href="#" class="text-light-white fw-600">Login</a></li>
							<li><a href="#" class="text-light-white fw-600">Track
									order</a></li>
						</ul>
					</div>
				</div>
				<div class="col-xl col-lg-4 col-md-4 col-sm-6">
					<div class="footer-links">
						...
						<ul>
							<li><a href="#" class="text-light-white fw-600">Suggest
									an Idea</a></li>
							<li><a href="#" class="text-light-white fw-600">Be a
									Partner restaurant</a></li>
							<li><a href="#" class="text-light-white fw-600">Create
									an Account</a></li>
				...
				<div class="col-xl col-lg-4 col-md-4 col-sm-6">
					<div class="footer-links">
						...
						<div class="appimg">
							<a href="#"> <img src="https://via.placeholder.com/150x40"
								class="img-fluid" alt="app logo">
							</a>
						</div>
						<div class="appimg">
							<a href="#"> <img src="https://via.placeholder.com/150x40"
				...
				<div class="col-lg-4">
					<div class="payment-logo mb-md-20">
						...
						<div class="payemt-icon">
							<img src="https://via.placeholder.com/60x30" alt="#"> <img
								src="https://via.placeholder.com/60x30" alt="#"> <img
								src="https://via.placeholder.com/60x30" alt="#"> <img
								src="https://via.placeholder.com/60x30" alt="#"> <img
								src="https://via.placeholder.com/60x30" alt="#">
						</div>
					</div>
				</div>
				<div class="col-lg-4 text-center medewithlove align-self-center">
					<a href="http://www.Slidesigma.com" class="text-light-black">Made
						with Real <i class="fas fa-heart"></i> Slidesigma
					</a>
				</div>
				<div class="col-lg-4">
					<div class="copyright-text">
						<span class="text-light-black">© <a href="#"
							class="text-light-white">Slidesigma</a> - 2020 | All Right
							Reserved
						</span>
					</div>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="name padding-10">
						<h3 class="text-light-black fw-700 mb-2">Sausage Egg McMuffin
							- Meal</h3>
					...
					<div class="additional-product">
							...
							<div class="card-header">
								<h5 class="no-margin">
									<a class="card-link collapsed text-light-black fw-700"
										data-toggle="collapse" href="#additionalOne"> <span>Select
											Breakfast Drink <span
											class="text-light-white fw-500 fs-12 padding-tb-10">Select
												one (Required)</span>
									</span>
									</a>
								</h5>
							...
							<div id="additionalOne" class="collapse">
								<div class="card-body padding-10">
									<button class="add-pro">
										Small Premium Roast Coffee (0 Cal.) <span>+$0.59</span> <span
											class="close">+</span>
									</button>
									<button class="add-pro">
										Small Premium Roast Coffee (0 Cal.) <span>+$0.59</span> <span
						...
						<div class="card">
							<div class="card-header">
								<h5 class="no-margin">
									<a class="card-link collapsed text-light-black fw-700"
										data-toggle="collapse" href="#additionalTwo"> <span>Select
											Breakfast Drink <span
											class="text-light-white fw-500 fs-12 padding-tb-10">Select
												one (Required)</span>
									</span>
						...
						<div class="card">
							<div class="card-header">
								<h5 class="no-margin">
									<a class="card-link collapsed text-light-black fw-700"
										data-toggle="collapse" href="#additionalThree"> <span>Select
											Breakfast Drink <span
											class="text-light-white fw-500 fs-12 padding-tb-10">Select
												one (Required)</span>
									</span>
						...
						<div class="card">
							<div class="card-header">
								<h5 class="no-margin">
									<a class="card-link collapsed text-light-black fw-700"
										data-toggle="collapse" href="#additionalFour"> <span>Select
											Breakfast Drink <span
											class="text-light-white fw-500 fs-12 padding-tb-10">Select
												one (Required)</span>
									</span>
